...
class Net(torch.nn.Module):
    def __init__(self, num_tasks=1, num_layer=4, emb_dim=300, drop_ratio = 0.5, residual = False, graph_pooling = "sum"):
        ...
        self.unet = GraphUNet(emb_dim, emb_dim, emb_dim, depth=num_layer, pool_ratios=drop_ratio)
    ...
    def forward(self, batched_data):
        ...
        h = F.dropout(self.node_emb(x), 0.5*self.drop_ratio, training=self.training)
        node_representation = self.unet(h, edge_index)
