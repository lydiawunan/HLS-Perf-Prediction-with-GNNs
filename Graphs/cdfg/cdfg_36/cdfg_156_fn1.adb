  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sext_ln22_fu_50_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_9">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>or_ln22_fu_54_p2</rtlName>
              <control/>
              <opType>or</opType>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_12">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sext_ln32_fu_72_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="30" tracking_level="1" version="0" object_id="_67">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>or_ln22_fu_54_p2 ( or ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
