...
extern "C" long long fn1_hw_stub_wrapper(int, long long, double, volatile void *, int);
...
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_13)[j];
  ...
  tcl_file.set_num(12, &tcl_file.p_13_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_13, __xlx_sprintf_buffer.data());
}
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13, __xlx_apatb_param_p_19);
