  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_6">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>p_cast_fu_76_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName>result</originalName>
              <rtlName>result_2_fu_80_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_10">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>result_1_cast1_fu_84_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_11">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>factor_fu_88_p3</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_14">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>xor_ln14_fu_105_p2</rtlName>
              <control/>
              <opType>xor</opType>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="36" tracking_level="1" version="0" object_id="_96">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>xor_ln14_fu_105_p2 ( xor ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
    ...
    <dp_fu_nodes_expression class_id="54" tracking_level="0" version="0">
      ...
      <item>
        <first>result_1_cast1_fu_84</first>
        <second>
          <count>1</count>
          <item_version>0</item_version>
          <item>18</item>
