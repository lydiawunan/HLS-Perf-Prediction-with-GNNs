  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>neg_cast_fu_85_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_10">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>zext_ln24_1_fu_95_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_11">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sub_ln24_fu_99_p2</rtlName>
              <control>auto</control>
              <opType>sub</opType>
              <implIndex>fabric</implIndex>
              <coreName>Adder</coreName>
        ...
        <item class_id_reference="9" object_id="_23">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>zext_ln33_fu_133_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="36" tracking_level="1" version="0" object_id="_134">
      ...
      <dp_register_resource>
        ...
        <item>
          <first>mul_ln23_1_reg_177</first>
          <second>
            <count>3</count>
            <item_version>0</item_version>
            <item>
