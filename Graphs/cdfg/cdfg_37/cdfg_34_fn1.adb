        ...
        <item class_id_reference="9" object_id="_5">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>not_s_fu_63_p2</rtlName>
              <control/>
              <opType>icmp</opType>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_6">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>div_cast_fu_69_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>xor_fu_73_p2</rtlName>
              <control/>
              <opType>xor</opType>
              <implIndex/>
              <coreName/>
              <coreId>1522169032</coreId>
            </Obj>
            <bitwidth>32</bitwidth>
          </Value>
          <oprand_edges>
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>conv5_fu_79_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_11">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>and_ln24_fu_83_p2</rtlName>
              <control/>
              <opType>and</opType>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="36" tracking_level="1" version="0" object_id="_81">
      ...
      <dp_expression_resource>
        ...
        <item class_id="38" tracking_level="0" version="0">
          <first>and_ln24_fu_83_p2 ( and ) </first>
        ...
        <item>
          <first>not_s_fu_63_p2 ( icmp ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
