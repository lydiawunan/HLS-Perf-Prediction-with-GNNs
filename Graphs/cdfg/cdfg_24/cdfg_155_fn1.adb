  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sext_ln30_fu_42_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>xor_ln30_fu_46_p2</rtlName>
              <control/>
              <opType>xor</opType>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_9">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sext_ln30_1_fu_52_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="30" tracking_level="1" version="0" object_id="_47">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>xor_ln30_fu_46_p2 ( xor ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
