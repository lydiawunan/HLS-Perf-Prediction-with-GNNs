  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_4">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sext_ln16_fu_36_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_6">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>and_ln16_fu_46_p2</rtlName>
              <control/>
              <opType>and</opType>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <rtlName>result_fu_52_p4</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="30" tracking_level="1" version="0" object_id="_40">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>and_ln16_fu_46_p2 ( and ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
