  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>p_15_cast_fu_54_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_10">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>empty_6_fu_70_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_11">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>icmp_ln21_fu_74_p2</rtlName>
              <control/>
              <opType>icmp</opType>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="36" tracking_level="1" version="0" object_id="_114">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>icmp_ln21_fu_74_p2 ( icmp ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
