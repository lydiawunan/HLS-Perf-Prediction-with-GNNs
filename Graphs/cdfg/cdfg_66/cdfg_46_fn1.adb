  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>conv3_fu_56_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_9">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sub41_neg_fu_60_p2</rtlName>
        ...
        <item class_id_reference="9" object_id="_10">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sub52_fu_66_p2</rtlName>
              <control>auto</control>
              <opType>sub</opType>
              <implIndex>tadder</implIndex>
              <coreName>TAddSub</coreName>
    ...
    <res class_id="36" tracking_level="1" version="0" object_id="_77">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>sub41_neg_fu_60_p2 ( + ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
