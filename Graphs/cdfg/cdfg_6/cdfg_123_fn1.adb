  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_4">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>zext_ln21_fu_36_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_5">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>add_ln21_fu_40_p2</rtlName>
        ...
        <item class_id_reference="9" object_id="_6">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>trunc_ln_fu_46_p4</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>zext_ln21_1_fu_56_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <rtlName>result_fu_60_p2</rtlName>
              <control/>
              <opType>xor</opType>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="30" tracking_level="1" version="0" object_id="_45">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>result_fu_60_p2 ( xor ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
