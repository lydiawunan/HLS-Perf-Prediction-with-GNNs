  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <rtlName>p_Val2_s_fu_68_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <rtlName>xs_exp_V_fu_72_p4</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_9">
          <Value>
            <Obj>
              ...
              <rtlName>p_Repl2_s_fu_82_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
              <coreId>1760645152</coreId>
            </Obj>
        ...
        <item class_id_reference="9" object_id="_24">
          <Value>
            <Obj>
              ...
              <rtlName>p_Result_s_reg_205</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_27">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sub_ln59_fu_194_p2</rtlName>
              <control>auto</control>
              <opType>sub</opType>
              <implIndex>fabric</implIndex>
              <coreName>Adder</coreName>
    ...
    <res class_id="34" tracking_level="1" version="0" object_id="_127">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>sub_ln59_fu_194_p2 ( - ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
      ...
      <dp_register_resource>
        ...
        <item>
          <first>select_ln1312_reg_210</first>
          <second>
            <count>3</count>
            <item_version>0</item_version>
            <item>
