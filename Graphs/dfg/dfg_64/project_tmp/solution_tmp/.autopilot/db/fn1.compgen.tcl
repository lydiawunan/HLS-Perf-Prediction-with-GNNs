...
set id 2
set name fn1_fdiv_32ns_32ns_32_16_no_dsp_1
...
set id 3
set name fn1_uitofp_32ns_32_6_no_dsp_1
...
set id 4
set name fn1_sitofp_32s_32_6_no_dsp_1
...
set id 5
set name fn1_urem_64ns_10ns_10_68_seq_1
...
set id 6
set name fn1_sdiv_8ns_17ns_7_12_seq_1
...
set id 7
set name fn1_mul_32ns_33s_64_2_1
...
set id 8
set name fn1_mul_mul_10ns_8s_18_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 18
set exp i0*i1
set arg_lists {i0 {10 0 +} i1 {8 1 +} p {18 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
