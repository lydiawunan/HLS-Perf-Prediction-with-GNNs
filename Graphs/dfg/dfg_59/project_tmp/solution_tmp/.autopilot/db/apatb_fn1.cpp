...
extern "C" float fn1_hw_stub_wrapper(double, long long);

extern "C" float apatb_fn1_hw(double __xlx_apatb_param_p, long long __xlx_apatb_param_p_9) {
...
float ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_9);
