...
extern "C" long long fn1_hw_stub_wrapper(short, char, char, volatile void *, double);
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_p_11)[j];
  ...
  tcl_file.set_num(40, &tcl_file.p_11_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_11, __xlx_sprintf_buffer.data());
}
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_15);
