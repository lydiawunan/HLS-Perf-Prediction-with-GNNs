...
extern "C" double fn1_hw_stub_wrapper(char, float, char, short, int);
...
double ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13, __xlx_apatb_param_p_19);
