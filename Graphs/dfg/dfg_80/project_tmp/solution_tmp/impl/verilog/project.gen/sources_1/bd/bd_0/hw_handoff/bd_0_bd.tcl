...
proc create_root_design { parentCell } {
  ...
  set p_11_d0 [ create_bd_port -dir O -from 31 -to 0 -type data p_11_d0 ]
  set p_11_d1 [ create_bd_port -dir O -from 31 -to 0 -type data p_11_d1 ]
  set p_11_q0 [ create_bd_port -dir I -from 31 -to 0 -type data p_11_q0 ]
  set p_11_q1 [ create_bd_port -dir I -from 31 -to 0 -type data p_11_q1 ]
