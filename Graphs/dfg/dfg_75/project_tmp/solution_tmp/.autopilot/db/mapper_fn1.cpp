...
extern "C" char fn1(int, double, short, long long*, int*);
extern "C" char apatb_fn1_hw(int __xlx_apatb_param_p, double __xlx_apatb_param_p_7, short __xlx_apatb_param_p_9, volatile void * __xlx_apatb_param_p_11, volatile void * __xlx_apatb_param_p_13) {
  ...
  vector<sc_bv<32> >__xlx_p_13__tmp_vec;
  for (int j = 0, e = 2; j != e; ++j) {
    __xlx_p_13__tmp_vec.push_back(((int*)__xlx_apatb_param_p_13)[j]);
  }
  int __xlx_size_param_p_13 = 2;
  int __xlx_offset_param_p_13 = 0;
  int __xlx_offset_byte_param_p_13 = 0*4;
  int* __xlx_p_13__input_buffer= new int[__xlx_p_13__tmp_vec.size()];
  for (int i = 0; i < __xlx_p_13__tmp_vec.size(); ++i) {
    __xlx_p_13__input_buffer[i] = __xlx_p_13__tmp_vec[i].range(31, 0).to_uint64();
  }
  // DUT call
  char ap_return = fn1(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_p_11__input_buffer, __xlx_p_13__input_buffer);
...
// print __xlx_apatb_param_p_13
  sc_bv<32>*__xlx_p_13_output_buffer = new sc_bv<32>[__xlx_size_param_p_13];
  for (int i = 0; i < __xlx_size_param_p_13; ++i) {
    __xlx_p_13_output_buffer[i] = __xlx_p_13__input_buffer[i+__xlx_offset_param_p_13];
  }
  for (int i = 0; i < __xlx_size_param_p_13; ++i) {
    ((int*)__xlx_apatb_param_p_13)[i] = __xlx_p_13_output_buffer[i].to_uint64();
  }
return ap_return;
}
