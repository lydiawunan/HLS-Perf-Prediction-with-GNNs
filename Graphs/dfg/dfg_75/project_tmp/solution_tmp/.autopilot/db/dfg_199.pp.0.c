...
__attribute__((sdx_kernel("fn1", 0))) unsigned char fn1(int p, double p_7, unsigned short p_9, long p_11[1][1],
                  int p_13[1][2])
{_ssdm_SpecArrayDimSize(p_11, 1);_ssdm_SpecArrayDimSize(p_13, 1);
