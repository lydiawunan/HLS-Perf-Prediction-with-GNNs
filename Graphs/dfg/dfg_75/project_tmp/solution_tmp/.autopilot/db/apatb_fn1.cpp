...
// wrapc file define:
#define AUTOTB_TVIN_p_13 "../tv/cdatafile/c.fn1.autotvin_p_13.dat"
#define AUTOTB_TVOUT_p_13 "../tv/cdatafile/c.fn1.autotvout_p_13.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_p_13 "../tv/rtldatafile/rtl.fn1.autotvout_p_13.dat"
...
extern "C" char fn1_hw_stub_wrapper(int, double, short, volatile void *, volatile void *);

extern "C" char apatb_fn1_hw(int __xlx_apatb_param_p, double __xlx_apatb_param_p_7, short __xlx_apatb_param_p_9, volatile void * __xlx_apatb_param_p_11, volatile void * __xlx_apatb_param_p_13) {
...
//p_13
aesl_fh.touch(AUTOTB_TVIN_p_13);
aesl_fh.touch(AUTOTB_TVOUT_p_13);
...
// print p_7 Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = *((long long*)&__xlx_apatb_param_p_7);
...
// print p_9 Transactions
{
  ...
  {
    sc_bv<16> __xlx_tmp_lv = *((short*)&__xlx_apatb_param_p_9);
...
unsigned __xlx_offset_byte_param_p_11 = 0;
// print p_11 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_p_11, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_p_11 = 0*8;
  if (__xlx_apatb_param_p_11) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_11)[j];
...
unsigned __xlx_offset_byte_param_p_13 = 0;
// print p_13 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_p_13, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_p_13 = 0*4;
  if (__xlx_apatb_param_p_13) {
    for (int j = 0  - 0, e = 2 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p_13)[j];
  ...
  tcl_file.set_num(2, &tcl_file.p_13_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_13, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
char ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
