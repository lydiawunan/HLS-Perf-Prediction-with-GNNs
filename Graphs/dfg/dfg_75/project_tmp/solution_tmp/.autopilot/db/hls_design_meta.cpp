...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("p_7", 64, hls_in, 1, "ap_none", "in_data", 1),
	Port_Property("p_9", 16, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("p_11", 64, hls_in, 3, "ap_none", "in_data", 1),
	Port_Property("p_13_address0", 1, hls_out, 4, "ap_memory", "mem_address", 1),
