...
proc create_root_design { parentCell } {
  ...
  set p_13_address0 [ create_bd_port -dir O -from 0 -to 0 -type data p_13_address0 ]
  set p_13_ce0 [ create_bd_port -dir O p_13_ce0 ]
  set p_13_q0 [ create_bd_port -dir I -from 31 -to 0 -type data p_13_q0 ]
  set p_7 [ create_bd_port -dir I -from 63 -to 0 -type data p_7 ]
  set p_9 [ create_bd_port -dir I -from 15 -to 0 -type data p_9 ]
