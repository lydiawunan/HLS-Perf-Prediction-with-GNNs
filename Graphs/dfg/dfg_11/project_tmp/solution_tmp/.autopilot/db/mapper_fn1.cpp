...
extern "C" char fn1(long long*, int);
extern "C" char apatb_fn1_hw(volatile void * __xlx_apatb_param_p, int __xlx_apatb_param_p_5) {
  ...
  // DUT call
  char ap_return = fn1(__xlx_p__input_buffer, __xlx_apatb_param_p_5);
