...
extern "C" char fn1_hw_stub_wrapper(volatile void *, int);
...
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p)[j];
  ...
  tcl_file.set_num(5, &tcl_file.p_depth);
...
char ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5);
