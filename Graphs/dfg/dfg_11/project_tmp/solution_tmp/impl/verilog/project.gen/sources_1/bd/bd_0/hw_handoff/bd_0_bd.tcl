...
proc create_root_design { parentCell } {
  ...
  set p_5 [ create_bd_port -dir I -from 31 -to 0 -type data p_5 ]
  set p_address0 [ create_bd_port -dir O -from 2 -to 0 -type data p_address0 ]
  set p_address1 [ create_bd_port -dir O -from 2 -to 0 -type data p_address1 ]
  set p_ce0 [ create_bd_port -dir O p_ce0 ]
  set p_ce1 [ create_bd_port -dir O p_ce1 ]
  set p_q0 [ create_bd_port -dir I -from 63 -to 0 -type data p_q0 ]
  set p_q1 [ create_bd_port -dir I -from 63 -to 0 -type data p_q1 ]
  ...
  connect_bd_net -net hls_inst_p_address1 [get_bd_ports p_address1] [get_bd_pins hls_inst/p_address1]
  connect_bd_net -net hls_inst_p_ce0 [get_bd_ports p_ce0] [get_bd_pins hls_inst/p_ce0]
  connect_bd_net -net hls_inst_p_ce1 [get_bd_ports p_ce1] [get_bd_pins hls_inst/p_ce1]
  ...
  connect_bd_net -net p_q1_0_1 [get_bd_ports p_q1] [get_bd_pins hls_inst/p_q1]
