  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_4">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>shl_ln21_fu_36_p2</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>trunc_ln21_fu_53_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>zext_ln21_fu_57_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="34" tracking_level="1" version="0" object_id="_158">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>result_fu_61_p2 ( xor ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
