...
__attribute__((sdx_kernel("fn1", 0))) unsigned short fn1(unsigned char p, long p_5, unsigned long p_7[1], long p_9,
                   short p_13[2][2])
{_ssdm_SpecArrayDimSize(p_7, 1);_ssdm_SpecArrayDimSize(p_13, 2);
