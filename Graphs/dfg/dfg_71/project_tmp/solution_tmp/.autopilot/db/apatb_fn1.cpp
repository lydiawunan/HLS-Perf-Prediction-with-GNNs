...
extern "C" int fn1_hw_stub_wrapper(long long, short, int, short, short);

extern "C" int apatb_fn1_hw(long long __xlx_apatb_param_p, short __xlx_apatb_param_p_5, int __xlx_apatb_param_p_9, short __xlx_apatb_param_p_11, short __xlx_apatb_param_p_15) {
...
// print p_9 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_9);
...
// print p_11 Transactions
{
  ...
  {
    sc_bv<16> __xlx_tmp_lv = *((short*)&__xlx_apatb_param_p_11);
...
int ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_15);
