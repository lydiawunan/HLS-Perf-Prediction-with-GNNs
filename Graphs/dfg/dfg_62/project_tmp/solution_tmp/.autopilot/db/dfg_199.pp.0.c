...
__attribute__((sdx_kernel("fn1", 0))) long fn1(unsigned int p, float p_11[4][3], int p_13, unsigned int p_15,
         unsigned long long p_17[2])
{_ssdm_SpecArrayDimSize(p_11, 4);_ssdm_SpecArrayDimSize(p_17, 2);
