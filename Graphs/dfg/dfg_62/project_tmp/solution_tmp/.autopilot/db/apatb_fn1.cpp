...
extern "C" long long fn1_hw_stub_wrapper(int, volatile void *, int, int, volatile void *);
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p_11)[j];
  ...
  tcl_file.set_num(12, &tcl_file.p_11_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_11, __xlx_sprintf_buffer.data());
}
...
// print p_17 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_17 = 0*8;
  if (__xlx_apatb_param_p_17) {
    for (int j = 0  - 0, e = 2 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_17)[j];
  ...
  tcl_file.set_num(2, &tcl_file.p_17_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_17, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13, __xlx_apatb_param_p_15, __xlx_apatb_param_p_17);
