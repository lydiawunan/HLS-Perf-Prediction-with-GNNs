...
extern "C" double fn1_hw_stub_wrapper(long long, volatile void *, int, char);

extern "C" double apatb_fn1_hw(long long __xlx_apatb_param_p, volatile void * __xlx_apatb_param_p_4, int __xlx_apatb_param_p_9, char __xlx_apatb_param_p_15) {
...
// print p_15 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_15);
...
double ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_4, __xlx_apatb_param_p_9, __xlx_apatb_param_p_15);
