...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name fn1_ap_dadddsub_5_full_dsp_64
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name fn1_ap_dadddsub_5_full_dsp_64 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips fn1_ap_dadddsub_5_full_dsp_64] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files fn1_ap_dadddsub_5_full_dsp_64.xci]
generate_target {synthesis simulation} [get_files fn1_ap_dadddsub_5_full_dsp_64.xci]
