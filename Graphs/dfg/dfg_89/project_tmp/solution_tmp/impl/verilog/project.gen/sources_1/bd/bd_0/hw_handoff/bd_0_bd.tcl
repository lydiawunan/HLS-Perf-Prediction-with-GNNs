...
proc create_root_design { parentCell } {
  ...
  set p_15 [ create_bd_port -dir I -from 7 -to 0 -type data p_15 ]
  set p_4_address0 [ create_bd_port -dir O -from 2 -to 0 -type data p_4_address0 ]
  set p_4_ce0 [ create_bd_port -dir O p_4_ce0 ]
  set p_4_q0 [ create_bd_port -dir I -from 31 -to 0 -type data p_4_q0 ]
  ...
  connect_bd_net -net hls_inst_p_4_address0 [get_bd_ports p_4_address0] [get_bd_pins hls_inst/p_4_address0]
  connect_bd_net -net hls_inst_p_4_ce0 [get_bd_ports p_4_ce0] [get_bd_pins hls_inst/p_4_ce0]
  ...
  connect_bd_net -net p_4_q0_0_1 [get_bd_ports p_4_q0] [get_bd_pins hls_inst/p_4_q0]
