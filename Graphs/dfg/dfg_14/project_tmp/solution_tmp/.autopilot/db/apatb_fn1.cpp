...
extern "C" int fn1_hw_stub_wrapper(char, long long, char);

extern "C" int apatb_fn1_hw(char __xlx_apatb_param_p, long long __xlx_apatb_param_p_5, char __xlx_apatb_param_p_11) {
...
// print p Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p);
...
// print p_11 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_11);
...
int ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_11);
