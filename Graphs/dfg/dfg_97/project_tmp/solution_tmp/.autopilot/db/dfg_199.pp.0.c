...
__attribute__((sdx_kernel("fn1", 0))) float fn1(unsigned int p, unsigned long p_4, unsigned short p_6[5],
          unsigned char p_8[5][4], float p_10[1][2][1])
{_ssdm_SpecArrayDimSize(p_6, 5);_ssdm_SpecArrayDimSize(p_8, 5);_ssdm_SpecArrayDimSize(p_10, 1);
