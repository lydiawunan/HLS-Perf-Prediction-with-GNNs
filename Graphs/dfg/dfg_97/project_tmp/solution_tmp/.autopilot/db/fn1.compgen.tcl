...
set id 9
set name fn1_urem_16ns_25ns_16_20_seq_1
...
set id 11
set name fn1_urem_16ns_17ns_17_20_seq_1
set corename simcore_urem_seq
set op urem
set stage_num 20
set max_latency -1
...
set id 12
set name fn1_udiv_32ns_33s_33_36_seq_1
set corename simcore_udiv_seq
set op udiv
set stage_num 36
set max_latency -1
...
set id 13
set name fn1_mul_mul_8ns_16s_24_4_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_6 \
    op interface \
    ports { p_6_address0 { O 3 vector } p_6_ce0 { O 1 bit } p_6_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'p_6'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_8 \
    op interface \
    ports { p_8_address0 { O 5 vector } p_8_ce0 { O 1 bit } p_8_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'p_8'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_10 \
    op interface \
    ports { p_10_address0 { O 1 vector } p_10_ce0 { O 1 bit } p_10_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'p_10'"
}
}
