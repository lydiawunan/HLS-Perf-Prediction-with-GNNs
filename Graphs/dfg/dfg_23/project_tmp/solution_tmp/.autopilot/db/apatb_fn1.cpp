...
extern "C" int fn1_hw_stub_wrapper(char, volatile void *, int, volatile void *);
...
// print p_13 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_13 = 0*1;
  if (__xlx_apatb_param_p_13) {
    for (int j = 0  - 0, e = 5 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p_13)[j];
...
int ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
