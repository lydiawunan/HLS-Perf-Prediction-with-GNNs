...
extern "C" int fn1(char, long long*, int, char*);
extern "C" int apatb_fn1_hw(char __xlx_apatb_param_p, volatile void * __xlx_apatb_param_p_7, int __xlx_apatb_param_p_11, volatile void * __xlx_apatb_param_p_13) {
  ...
  vector<sc_bv<8> >__xlx_p_13__tmp_vec;
  for (int j = 0, e = 5; j != e; ++j) {
    __xlx_p_13__tmp_vec.push_back(((char*)__xlx_apatb_param_p_13)[j]);
  }
  int __xlx_size_param_p_13 = 5;
  int __xlx_offset_param_p_13 = 0;
  int __xlx_offset_byte_param_p_13 = 0*1;
  char* __xlx_p_13__input_buffer= new char[__xlx_p_13__tmp_vec.size()];
  for (int i = 0; i < __xlx_p_13__tmp_vec.size(); ++i) {
    __xlx_p_13__input_buffer[i] = __xlx_p_13__tmp_vec[i].range(7, 0).to_uint64();
  }
  // DUT call
  int ap_return = fn1(__xlx_apatb_param_p, __xlx_p_7__input_buffer, __xlx_apatb_param_p_11, __xlx_p_13__input_buffer);
...
// print __xlx_apatb_param_p_13
  sc_bv<8>*__xlx_p_13_output_buffer = new sc_bv<8>[__xlx_size_param_p_13];
  for (int i = 0; i < __xlx_size_param_p_13; ++i) {
    __xlx_p_13_output_buffer[i] = __xlx_p_13__input_buffer[i+__xlx_offset_param_p_13];
  }
  for (int i = 0; i < __xlx_size_param_p_13; ++i) {
    ((char*)__xlx_apatb_param_p_13)[i] = __xlx_p_13_output_buffer[i].to_uint64();
  }
return ap_return;
}
