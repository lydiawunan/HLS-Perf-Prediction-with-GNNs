...
__attribute__((sdx_kernel("fn1", 0))) unsigned int fn1(signed char p, long p_7[5], int p_11, char p_13[5])
{_ssdm_SpecArrayDimSize(p_7, 5);_ssdm_SpecArrayDimSize(p_13, 5);
