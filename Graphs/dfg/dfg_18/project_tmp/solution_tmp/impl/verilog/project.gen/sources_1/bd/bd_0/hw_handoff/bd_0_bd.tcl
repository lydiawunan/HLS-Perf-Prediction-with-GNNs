...
proc create_root_design { parentCell } {
  ...
  set p_15 [ create_bd_port -dir I -from 15 -to 0 -type data p_15 ]
  set p_17 [ create_bd_port -dir I -from 63 -to 0 -type data p_17 ]
  set p_19_address0 [ create_bd_port -dir O -from 3 -to 0 -type data p_19_address0 ]
  set p_19_ce0 [ create_bd_port -dir O p_19_ce0 ]
  set p_19_q0 [ create_bd_port -dir I -from 63 -to 0 -type data p_19_q0 ]
  ...
  connect_bd_net -net hls_inst_p_19_address0 [get_bd_ports p_19_address0] [get_bd_pins hls_inst/p_19_address0]
  connect_bd_net -net hls_inst_p_19_ce0 [get_bd_ports p_19_ce0] [get_bd_pins hls_inst/p_19_ce0]
  ...
  connect_bd_net -net p_17_0_1 [get_bd_ports p_17] [get_bd_pins hls_inst/p_17]
  connect_bd_net -net p_19_q0_0_1 [get_bd_ports p_19_q0] [get_bd_pins hls_inst/p_19_q0]
