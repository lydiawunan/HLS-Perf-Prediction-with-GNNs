...
set C_modelArgList {
	{ p int 32 regular  }
	{ p_5 double 64 regular  }
	{ p_15 int 16 regular  }
	{ p_17 int 64 regular  }
	{ p_19 int 64 regular {array 16 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "p_19", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p_19","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ p_15 sc_in sc_lv 16 signal 2 } 
	{ p_17 sc_in sc_lv 64 signal 3 } 
	{ p_19_address0 sc_out sc_lv 4 signal 4 } 
	{ p_19_ce0 sc_out sc_logic 1 signal 4 } 
	{ p_19_q0 sc_in sc_lv 64 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_19_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "p_19", "role": "address0" }} , 
 	{ "name": "p_19_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_19", "role": "ce0" }} , 
 	{ "name": "p_19_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "p_19", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"Port" : [
			...
			{"Name" : "p_19", "Type" : "Memory", "Direction" : "I"}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_64s_64_6_no_dsp_1_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_16s_16s_32_4_1_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_16s_15s_31_4_1_U6", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fn1 {
		p {Type I LastRead 20 FirstWrite -1}
		p_5 {Type I LastRead 78 FirstWrite -1}
		p_15 {Type I LastRead 9 FirstWrite -1}
		p_17 {Type I LastRead 9 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	p_19 { ap_memory {  { p_19_address0 mem_address 1 4 }  { p_19_ce0 mem_ce 1 1 }  { p_19_q0 mem_dout 0 64 } } }
}
