        ...
        <item class_id_reference="9" object_id="_4">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>trunc_ln31_fu_36_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_6">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>zext_ln33_fu_46_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sub_ln33_fu_49_p2</rtlName>
              <control>auto</control>
              <opType>sub</opType>
              <implIndex>fabric</implIndex>
              <coreName>Adder</coreName>
        ...
        <item class_id_reference="9" object_id="_10">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>trunc_ln33_fu_65_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="16" object_id="_15">
          <Value>
            <Obj>
              ...
              <implIndex/>
              <coreName/>
              <coreId>3582216624</coreId>
            </Obj>
            <bitwidth>64</bitwidth>
          </Value>
          <const_type>0</const_type>
          <content>18446744073709496925</content>
        </item>
        <item class_id_reference="16" object_id="_16">
          <Value>
            <Obj>
              ...
              <implIndex/>
              <coreName/>
              <coreId>3582224016</coreId>
            </Obj>
            <bitwidth>16</bitwidth>
          </Value>
          <const_type>0</const_type>
          <content>60281</content>
        </item>
      </consts>
