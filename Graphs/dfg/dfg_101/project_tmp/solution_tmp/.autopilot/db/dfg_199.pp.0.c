...
__attribute__((sdx_kernel("fn1", 0))) short fn1(unsigned long long p, unsigned short p_5, char p_7[1], char p_9[1],
          double p_11)
{_ssdm_SpecArrayDimSize(p_7, 1);_ssdm_SpecArrayDimSize(p_9, 1);
