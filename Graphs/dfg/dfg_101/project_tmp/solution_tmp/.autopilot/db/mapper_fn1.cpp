...
extern "C" short fn1(long long, short, char*, char*, double);
extern "C" short apatb_fn1_hw(long long __xlx_apatb_param_p, short __xlx_apatb_param_p_5, volatile void * __xlx_apatb_param_p_7, volatile void * __xlx_apatb_param_p_9, double __xlx_apatb_param_p_11) {
  ...
  vector<sc_bv<8> >__xlx_p_7__tmp_vec;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_p_7__tmp_vec.push_back(((char*)__xlx_apatb_param_p_7)[j]);
  }
  int __xlx_size_param_p_7 = 1;
  int __xlx_offset_param_p_7 = 0;
  int __xlx_offset_byte_param_p_7 = 0*1;
  char* __xlx_p_7__input_buffer= new char[__xlx_p_7__tmp_vec.size()];
  for (int i = 0; i < __xlx_p_7__tmp_vec.size(); ++i) {
    __xlx_p_7__input_buffer[i] = __xlx_p_7__tmp_vec[i].range(7, 0).to_uint64();
  }
  ...
  // DUT call
  short ap_return = fn1(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_p_7__input_buffer, __xlx_p_9__input_buffer, __xlx_apatb_param_p_11);
// print __xlx_apatb_param_p_7
  sc_bv<8>*__xlx_p_7_output_buffer = new sc_bv<8>[__xlx_size_param_p_7];
  for (int i = 0; i < __xlx_size_param_p_7; ++i) {
    __xlx_p_7_output_buffer[i] = __xlx_p_7__input_buffer[i+__xlx_offset_param_p_7];
  }
  for (int i = 0; i < __xlx_size_param_p_7; ++i) {
    ((char*)__xlx_apatb_param_p_7)[i] = __xlx_p_7_output_buffer[i].to_uint64();
  }
