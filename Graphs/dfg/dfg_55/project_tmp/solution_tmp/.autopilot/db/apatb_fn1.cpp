...
extern "C" double fn1_hw_stub_wrapper(char, char, long long);
...
double ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_13, __xlx_apatb_param_p_17);
