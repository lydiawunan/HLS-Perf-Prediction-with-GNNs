...
__attribute__((sdx_kernel("fn1", 0))) unsigned int fn1(unsigned long long p, float p_4[4][4], unsigned int p_6,
                 signed char p_9, unsigned int p_13[5])
{_ssdm_SpecArrayDimSize(p_4, 4);_ssdm_SpecArrayDimSize(p_13, 5);
