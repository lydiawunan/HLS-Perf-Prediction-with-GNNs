        ...
        <item class_id_reference="9" object_id="_3">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>trunc_ln18_fu_36_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_7">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>select_ln19_fu_60_p3</rtlName>
              <control>auto</control>
        ...
        <item class_id_reference="9" object_id="_8">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>and_ln19_fu_68_p2</rtlName>
              <control/>
              <opType>and</opType>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="30" tracking_level="1" version="0" object_id="_49">
      ...
      <dp_expression_resource>
        ...
        <item class_id="32" tracking_level="0" version="0">
          <first>and_ln19_fu_68_p2 ( and ) </first>
        ...
        <item>
          <first>select_ln19_fu_60_p3 ( select ) </first>
          <second>
            <count>5</count>
            <item_version>0</item_version>
            <item>
