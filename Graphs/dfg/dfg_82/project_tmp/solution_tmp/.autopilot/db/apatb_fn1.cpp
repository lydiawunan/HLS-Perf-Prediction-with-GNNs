...
extern "C" long long fn1_hw_stub_wrapper(volatile void *, long long, volatile void *, long long, long long);

extern "C" long long apatb_fn1_hw(volatile void * __xlx_apatb_param_p, long long __xlx_apatb_param_p_9, volatile void * __xlx_apatb_param_p_11, long long __xlx_apatb_param_p_13, long long __xlx_apatb_param_p_17) {
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p)[j];
  ...
  tcl_file.set_num(2, &tcl_file.p_depth);
...
// print p_11 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_11 = 0*4;
  if (__xlx_apatb_param_p_11) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p_11)[j];
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13, __xlx_apatb_param_p_17);
