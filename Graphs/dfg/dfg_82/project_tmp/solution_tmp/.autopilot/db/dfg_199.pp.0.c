...
__attribute__((sdx_kernel("fn1", 0))) long fn1(int p[2], unsigned long p_9, float p_11[4], long p_13, long p_17)
{_ssdm_SpecArrayDimSize(p, 2);_ssdm_SpecArrayDimSize(p_11, 4);
