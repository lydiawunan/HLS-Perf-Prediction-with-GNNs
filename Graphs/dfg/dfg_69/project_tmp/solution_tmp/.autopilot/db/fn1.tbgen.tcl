...
set C_modelArgList {
	{ p int 64 regular {array 4 { 1 3 } 1 1 }  }
	{ p_4 int 16 regular  }
	{ p_6 int 64 regular  }
	{ p_8 int 8 regular  }
	{ p_13 int 16 regular {array 10 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "p_8", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p_8","cData": "char","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ p_8 sc_in sc_lv 8 signal 3 } 
	{ p_13_address0 sc_out sc_lv 4 signal 4 } 
	{ p_13_ce0 sc_out sc_logic 1 signal 4 } 
	{ p_13_q0 sc_in sc_lv 16 signal 4 } 
	{ p_13_address1 sc_out sc_lv 4 signal 4 } 
	{ p_13_ce1 sc_out sc_logic 1 signal 4 } 
	{ p_13_q1 sc_in sc_lv 16 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_8", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_8", "role": "default" }} , 
 	...
 	{ "name": "p_13_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "p_13", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitofp_64ns_32_6_no_dsp_1_U2", "Parent" : "0"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_17s_33ns_50_2_1_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_17s_31s_48_2_1_U6", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.udiv_64s_64ns_64_68_seq_1_U7", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_31ns_39_2_1_U8", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64ns_66ns_129_5_1_U9", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_17ns_32_2_1_U10", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_3ns_32ns_3_7_seq_1_U11", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	fn1 {
		...
		p_6 {Type I LastRead 112 FirstWrite -1}
		p_8 {Type I LastRead 88 FirstWrite -1}
		p_13 {Type I LastRead 24 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	p { ap_memory {  { p_address0 mem_address 1 2 }  { p_ce0 mem_ce 1 1 }  { p_q0 mem_dout 0 64 } } }
	p_4 { ap_none {  { p_4 in_data 0 16 } } }
	p_6 { ap_none {  { p_6 in_data 0 64 } } }
	p_8 { ap_none {  { p_8 in_data 0 8 } } }
	p_13 { ap_memory {  { p_13_address0 mem_address 1 4 }  { p_13_ce0 mem_ce 1 1 }  { p_13_q0 mem_dout 0 16 }  { p_13_address1 MemPortADDR2 1 4 }  { p_13_ce1 MemPortCE2 1 1 }  { p_13_q1 MemPortDOUT2 0 16 } } }
}
