...
__attribute__((sdx_kernel("fn1", 0))) double fn1(long long p[4][1], short p_4, unsigned long long p_6, char p_8,
           unsigned short p_13[1][5][2])
{_ssdm_SpecArrayDimSize(p, 4);_ssdm_SpecArrayDimSize(p_13, 1);
