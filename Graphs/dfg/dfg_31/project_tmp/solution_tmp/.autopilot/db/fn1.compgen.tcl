...
set id 3
set name fn1_srem_8ns_7ns_8_12_seq_1
...
set id 4
set name fn1_sdiv_11s_33ns_8_15_seq_1
...
set id 5
set name fn1_mac_muladd_16s_16s_1ns_31_4_1
...
set out_width 31
set exp i0*i1+i2
set arg_lists {i0 {16 1 +} i1 {16 1 +} m {31 1 +} i2 {1 0 +} p {31 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p \
    op interface \
    ports { p_address0 { O 1 vector } p_ce0 { O 1 bit } p_q0 { I 8 vector } } \
} "
} else {
