...
extern "C" char fn1_hw_stub_wrapper(volatile void *, char);
...
// print p_4 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_4);
...
char ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_4);
