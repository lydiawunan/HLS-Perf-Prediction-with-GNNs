...
extern "C" char fn1(char*, char);
extern "C" char apatb_fn1_hw(volatile void * __xlx_apatb_param_p, char __xlx_apatb_param_p_4) {
  ...
  // DUT call
  char ap_return = fn1(__xlx_p__input_buffer, __xlx_apatb_param_p_4);
