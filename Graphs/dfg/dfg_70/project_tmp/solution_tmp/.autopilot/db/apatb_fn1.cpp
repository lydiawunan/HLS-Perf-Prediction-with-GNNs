...
extern "C" short fn1_hw_stub_wrapper(int, float, short, long long);

extern "C" short apatb_fn1_hw(int __xlx_apatb_param_p, float __xlx_apatb_param_p_5, short __xlx_apatb_param_p_13, long long __xlx_apatb_param_p_15) {
...
// print p_5 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_5);
...
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_13, __xlx_apatb_param_p_15);
