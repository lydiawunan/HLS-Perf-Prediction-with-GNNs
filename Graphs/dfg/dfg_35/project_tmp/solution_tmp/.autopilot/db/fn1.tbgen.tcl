...
set C_modelArgList {
	{ p int 32 regular  }
	{ p_4 int 8 regular {array 2 { 1 3 } 1 1 }  }
	{ p_7 int 64 regular  }
	{ p_9 uint 8 unused  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "p_4", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p_4","cData": "char","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ p_4_address0 sc_out sc_lv 1 signal 1 } 
	{ p_4_ce0 sc_out sc_logic 1 signal 1 } 
	{ p_4_q0 sc_in sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "p_4", "role": "address0" }} , 
 	{ "name": "p_4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_4", "role": "ce0" }} , 
 	{ "name": "p_4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_4", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.udiv_29s_9ns_29_33_seq_1_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_8s_32_2_1_U6", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_30s_32_2_1_U7", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fn1 {
		p {Type I LastRead 33 FirstWrite -1}
		p_4 {Type I LastRead 0 FirstWrite -1}
		p_7 {Type I LastRead 32 FirstWrite -1}
		p_9 {Type I LastRead -1 FirstWrite -1}
		p_11 {Type I LastRead 14 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	p_4 { ap_memory {  { p_4_address0 mem_address 1 1 }  { p_4_ce0 mem_ce 1 1 }  { p_4_q0 mem_dout 0 8 } } }
