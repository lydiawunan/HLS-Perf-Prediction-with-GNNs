...
extern "C" int fn1_hw_stub_wrapper(int, volatile void *, long long, char, float);
...
// print p_4 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_4 = 0*1;
  if (__xlx_apatb_param_p_4) {
    for (int j = 0  - 0, e = 2 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p_4)[j];
  ...
  tcl_file.set_num(2, &tcl_file.p_4_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_4, __xlx_sprintf_buffer.data());
}
...
int ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_4, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11);
