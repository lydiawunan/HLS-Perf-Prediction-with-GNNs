...
extern "C" short fn1_hw_stub_wrapper(short, char, volatile void *);
...
// print p_13 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_13 = 0*8;
  if (__xlx_apatb_param_p_13) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_13)[j];
  ...
  tcl_file.set_num(4, &tcl_file.p_13_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_13, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_9, __xlx_apatb_param_p_13);
