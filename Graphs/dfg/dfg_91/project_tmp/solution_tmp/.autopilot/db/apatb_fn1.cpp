...
extern "C" short fn1_hw_stub_wrapper(int, volatile void *, volatile void *, volatile void *, long long);
...
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_7)[j];
  ...
  tcl_file.set_num(20, &tcl_file.p_7_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_7, __xlx_sprintf_buffer.data());
}
...
// print p_9 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_9 = 0*2;
  if (__xlx_apatb_param_p_9) {
    for (int j = 0  - 0, e = 3 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_p_9)[j];
  ...
  tcl_file.set_num(3, &tcl_file.p_9_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_9, __xlx_sprintf_buffer.data());
}
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p_11)[j];
  ...
  tcl_file.set_num(8, &tcl_file.p_11_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_11, __xlx_sprintf_buffer.data());
}
...
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
