...
__attribute__((sdx_kernel("fn1", 0))) unsigned short fn1(int p, long p_7[5][4], unsigned short p_9[1][3][1],
                   char p_11[4][1][2], long p_13)
{_ssdm_SpecArrayDimSize(p_7, 5);_ssdm_SpecArrayDimSize(p_9, 1);_ssdm_SpecArrayDimSize(p_11, 4);
