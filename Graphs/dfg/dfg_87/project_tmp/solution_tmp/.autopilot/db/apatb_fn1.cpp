...
extern "C" int fn1_hw_stub_wrapper(short, int);

extern "C" int apatb_fn1_hw(short __xlx_apatb_param_p, int __xlx_apatb_param_p_13) {
...
// print p Transactions
{
  ...
  {
    sc_bv<16> __xlx_tmp_lv = *((short*)&__xlx_apatb_param_p);
...
int ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_13);
