...
extern "C" long long fn1_hw_stub_wrapper(int, long long, volatile void *, volatile void *);

extern "C" long long apatb_fn1_hw(int __xlx_apatb_param_p, long long __xlx_apatb_param_p_5, volatile void * __xlx_apatb_param_p_7, volatile void * __xlx_apatb_param_p_9) {
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p_7)[j];
  ...
  tcl_file.set_num(75, &tcl_file.p_7_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_7, __xlx_sprintf_buffer.data());
}
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9);
