...
__attribute__((sdx_kernel("fn1", 0))) unsigned long long fn1(int p, long long p_5, signed char p_7[3][5][5],
                       double p_9[2])
{_ssdm_SpecArrayDimSize(p_7, 3);_ssdm_SpecArrayDimSize(p_9, 2);
