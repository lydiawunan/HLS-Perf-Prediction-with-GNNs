...
set C_modelArgList {
	{ p int 32 regular  }
	{ p_5 int 64 regular  }
	{ p_7 int 8 regular {array 75 { 1 3 } 1 1 }  }
	{ p_9 int 64 regular {array 2 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "p_7", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p_7","cData": "char","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ p_7_address0 sc_out sc_lv 7 signal 2 } 
	{ p_7_ce0 sc_out sc_logic 1 signal 2 } 
	{ p_7_q0 sc_in sc_lv 8 signal 2 } 
	{ p_9_address0 sc_out sc_lv 1 signal 3 } 
	{ p_9_ce0 sc_out sc_logic 1 signal 3 } 
	{ p_9_q0 sc_in sc_lv 64 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_7_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "p_7", "role": "address0" }} , 
 	{ "name": "p_7_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_7", "role": "ce0" }} , 
 	{ "name": "p_7_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_7", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.udiv_64s_64ns_8_68_seq_1_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.srem_9s_15ns_15_13_seq_1_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_8s_32_2_1_U4", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fn1 {
		p {Type I LastRead 87 FirstWrite -1}
		p_5 {Type I LastRead 89 FirstWrite -1}
		p_7 {Type I LastRead 75 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	p_7 { ap_memory {  { p_7_address0 mem_address 1 7 }  { p_7_ce0 mem_ce 1 1 }  { p_7_q0 mem_dout 0 8 } } }
	p_9 { ap_memory {  { p_9_address0 mem_address 1 1 }  { p_9_ce0 mem_ce 1 1 }  { p_9_q0 mem_dout 0 64 } } }
}
