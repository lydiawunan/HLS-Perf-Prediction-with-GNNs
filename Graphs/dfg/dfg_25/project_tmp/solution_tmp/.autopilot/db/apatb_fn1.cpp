...
extern "C" long long fn1_hw_stub_wrapper(short, int, int, char);

extern "C" long long apatb_fn1_hw(short __xlx_apatb_param_p, int __xlx_apatb_param_p_9, int __xlx_apatb_param_p_11, char __xlx_apatb_param_p_13) {
...
// print p_11 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_11);
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
