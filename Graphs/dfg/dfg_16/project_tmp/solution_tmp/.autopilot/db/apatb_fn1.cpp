...
extern "C" long long fn1_hw_stub_wrapper(volatile void *, volatile void *, long long, int);
...
unsigned __xlx_offset_byte_param_p = 0;
// print p Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_p, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_p = 0*1;
  if (__xlx_apatb_param_p) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p)[j];
  ...
  tcl_file.set_num(4, &tcl_file.p_depth);
...
// print p_7 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_7 = 0*4;
  if (__xlx_apatb_param_p_7) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p_7)[j];
...
// print p_9 Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = *((long long*)&__xlx_apatb_param_p_9);
...
// print p_13 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_13);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_p_13, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.p_13_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_13, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_13);
