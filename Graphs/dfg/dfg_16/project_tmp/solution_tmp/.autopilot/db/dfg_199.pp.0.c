...
__attribute__((sdx_kernel("fn1", 0))) long fn1(unsigned char p[1][4], unsigned int p_7[1], unsigned long p_9,
         int p_13)
{_ssdm_SpecArrayDimSize(p, 1);_ssdm_SpecArrayDimSize(p_7, 1);
