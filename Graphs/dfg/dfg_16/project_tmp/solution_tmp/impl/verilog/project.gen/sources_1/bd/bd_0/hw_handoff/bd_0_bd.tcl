...
proc create_root_design { parentCell } {
  ...
  set p_7 [ create_bd_port -dir I -from 31 -to 0 -type data p_7 ]
  ...
  set p_q0 [ create_bd_port -dir I -from 7 -to 0 -type data p_q0 ]
  ...
  connect_bd_net -net p_7_0_1 [get_bd_ports p_7] [get_bd_pins hls_inst/p_7]
