...
extern "C" int fn1_hw_stub_wrapper(long long, float, int, double);
...
int ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11);
