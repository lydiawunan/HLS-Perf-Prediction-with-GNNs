...
__attribute__((sdx_kernel("fn1", 0))) short fn1(int p[1], unsigned short p_11[1], int p_13, unsigned int p_15,
          unsigned short p_19)
{_ssdm_SpecArrayDimSize(p, 1);_ssdm_SpecArrayDimSize(p_11, 1);
