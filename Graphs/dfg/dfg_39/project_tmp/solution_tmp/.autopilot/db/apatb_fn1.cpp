...
extern "C" short fn1_hw_stub_wrapper(volatile void *, volatile void *, int, int, short);
...
// print p Transactions
{
  ...
  {  __xlx_offset_byte_param_p = 0*4;
  if (__xlx_apatb_param_p) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p)[j];
...
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13, __xlx_apatb_param_p_15, __xlx_apatb_param_p_19);
