...
extern "C" float fn1_hw_stub_wrapper(long long, char, char, float, float);
...
float ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
