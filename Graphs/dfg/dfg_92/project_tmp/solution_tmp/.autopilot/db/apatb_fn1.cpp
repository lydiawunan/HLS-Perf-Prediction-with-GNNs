...
extern "C" double fn1_hw_stub_wrapper(double, char);

extern "C" double apatb_fn1_hw(double __xlx_apatb_param_p, char __xlx_apatb_param_p_5) {
...
double ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5);
