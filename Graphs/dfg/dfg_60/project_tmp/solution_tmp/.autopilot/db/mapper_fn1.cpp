...
extern "C" short fn1(char*, long long*, long long, char, short);
extern "C" short apatb_fn1_hw(volatile void * __xlx_apatb_param_p, volatile void * __xlx_apatb_param_p_4, long long __xlx_apatb_param_p_6, char __xlx_apatb_param_p_9, short __xlx_apatb_param_p_13) {
  ...
  vector<sc_bv<64> >__xlx_p_4__tmp_vec;
  for (int j = 0, e = 8; j != e; ++j) {
    __xlx_p_4__tmp_vec.push_back(((long long*)__xlx_apatb_param_p_4)[j]);
  }
  int __xlx_size_param_p_4 = 8;
  int __xlx_offset_param_p_4 = 0;
  int __xlx_offset_byte_param_p_4 = 0*8;
  long long* __xlx_p_4__input_buffer= new long long[__xlx_p_4__tmp_vec.size()];
  for (int i = 0; i < __xlx_p_4__tmp_vec.size(); ++i) {
    __xlx_p_4__input_buffer[i] = __xlx_p_4__tmp_vec[i].range(63, 0).to_uint64();
  }
  // DUT call
  short ap_return = fn1(__xlx_p__input_buffer, __xlx_p_4__input_buffer, __xlx_apatb_param_p_6, __xlx_apatb_param_p_9, __xlx_apatb_param_p_13);
...
// print __xlx_apatb_param_p_4
  sc_bv<64>*__xlx_p_4_output_buffer = new sc_bv<64>[__xlx_size_param_p_4];
  for (int i = 0; i < __xlx_size_param_p_4; ++i) {
    __xlx_p_4_output_buffer[i] = __xlx_p_4__input_buffer[i+__xlx_offset_param_p_4];
  }
  for (int i = 0; i < __xlx_size_param_p_4; ++i) {
    ((long long*)__xlx_apatb_param_p_4)[i] = __xlx_p_4_output_buffer[i].to_uint64();
  }
return ap_return;
}
