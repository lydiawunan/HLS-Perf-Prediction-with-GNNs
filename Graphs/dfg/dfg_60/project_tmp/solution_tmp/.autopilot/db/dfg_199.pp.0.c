...
__attribute__((sdx_kernel("fn1", 0))) short fn1(signed char p[5][3][1], unsigned long p_4[2][4], unsigned long p_6,
          signed char p_9, short p_13)
{_ssdm_SpecArrayDimSize(p, 5);_ssdm_SpecArrayDimSize(p_4, 2);
