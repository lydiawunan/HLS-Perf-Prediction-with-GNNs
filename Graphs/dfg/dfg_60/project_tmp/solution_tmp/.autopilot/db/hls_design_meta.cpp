...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("p_4_address0", 3, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("p_4_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("p_4_q0", 64, hls_in, 1, "ap_memory", "mem_dout", 1),
	Port_Property("p_6", 64, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("p_9", 8, hls_in, 3, "ap_none", "in_data", 1),
	Port_Property("p_13", 16, hls_in, 4, "ap_none", "in_data", 1),
