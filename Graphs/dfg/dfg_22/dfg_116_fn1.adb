  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_3">
          <Value>
            <Obj>
              ...
              <rtlName>result_fu_30_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_4">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>icmp_ln17_fu_34_p2</rtlName>
              <control/>
              <opType>icmp</opType>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_5">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>zext_ln17_fu_40_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="30" tracking_level="1" version="0" object_id="_36">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>icmp_ln17_fu_34_p2 ( icmp ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
