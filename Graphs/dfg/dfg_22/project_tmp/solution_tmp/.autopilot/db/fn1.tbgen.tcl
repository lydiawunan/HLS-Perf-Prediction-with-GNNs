...
set C_modelArgMapList {[ 
	{ "Name" : "p", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "p_17", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p_17","cData": "short","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_17", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "p_17", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.uitodp_64ns_64_6_no_dsp_1_U6", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	fn1 {
		...
		p_13 {Type I LastRead 6 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	p_17 { ap_none {  { p_17 in_data 0 16 } } }
}
