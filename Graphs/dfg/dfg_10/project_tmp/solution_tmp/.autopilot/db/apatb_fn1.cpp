...
extern "C" long long fn1_hw_stub_wrapper(long long, volatile void *, int);
...
// print p_7 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_7 = 0*8;
  if (__xlx_apatb_param_p_7) {
    for (int j = 0  - 0, e = 15 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_7)[j];
  ...
  tcl_file.set_num(15, &tcl_file.p_7_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_7, __xlx_sprintf_buffer.data());
}
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9);
