...
extern "C" long long fn1_hw_stub_wrapper(int, volatile void *, long long, long long);
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p_7)[j];
  ...
  tcl_file.set_num(40, &tcl_file.p_7_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_7, __xlx_sprintf_buffer.data());
}
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
