...
extern "C" short fn1_hw_stub_wrapper(long long, int, float);
...
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_11, __xlx_apatb_param_p_15);
