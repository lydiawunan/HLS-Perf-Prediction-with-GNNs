...
set id 1
set name fn1_urem_64s_11ns_64_68_seq_1
...
set id 2
set name fn1_mac_muladd_8s_17s_16ns_24_4_1
...
set out_width 24
set exp i0*i1+i2
set arg_lists {i0 {8 1 +} i1 {17 1 +} m {24 1 +} i2 {16 0 +} p {24 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
