...
architecture behav of fn1 is 
    ...
    "fn1_fn1,hls_ip_2020_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.071000,HLS_SYN_LAT=71,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=882,HLS_SYN_LUT=837,HLS_VERSION=2020_2}";
    ...
    constant ap_const_lv24_FF362B : STD_LOGIC_VECTOR (23 downto 0) := "111111110011011000101011";
    ...
    signal tmp_1_reg_143 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_2_reg_148 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_fu_130_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal add_ln23_1_reg_163 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal tmp_fu_54_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_62_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_fu_72_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal sext_ln23_fu_86_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal and_ln_fu_89_p7 : STD_LOGIC_VECTOR (13 downto 0);
    signal sext_ln23_1_fu_103_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal zext_ln23_fu_107_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal add_ln23_fu_111_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_124_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_124_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_fu_130_p1 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal grp_fu_130_p20 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component fn1_urem_64s_11ns_64_68_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component fn1_mac_muladd_8s_17s_16ns_24_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    urem_64s_11ns_64_68_seq_1_U1 : component fn1_urem_64s_11ns_64_68_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 68,
        din0_WIDTH => 64,
    ...
    mac_muladd_8s_17s_16ns_24_4_1_U2 : component fn1_mac_muladd_8s_17s_16ns_24_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                tmp_1_reg_143 <= tmp_1_fu_62_p1(7 downto 6);
                tmp_2_reg_148 <= tmp_2_fu_72_p1(4 downto 1);
                tmp_reg_138 <= tmp_fu_54_p1(7 downto 7);
            end if;
        end if;
    end process;
    ...
    add_ln23_fu_111_p2 <= std_logic_vector(unsigned(zext_ln23_fu_107_p1) + unsigned(ap_const_lv16_93));
    and_ln_fu_89_p7 <= (((((tmp_reg_138 & ap_const_lv3_0) & sext_ln23_fu_86_p1) & ap_const_lv1_0) & tmp_2_reg_148) & ap_const_lv1_0);
    ...
    grp_fu_124_ap_start_assign_proc : process(ap_CS_fsm_state5)
    begin
        ...
        grp_fu_124_p0 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln23_1_reg_163),64));

    grp_fu_124_p1 <= ap_const_lv64_3C2(11 - 1 downto 0);
    grp_fu_130_p1 <= ap_const_lv24_FF362B(17 - 1 downto 0);
    grp_fu_130_p2 <= grp_fu_130_p20(16 - 1 downto 0);
    grp_fu_130_p20 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln23_fu_111_p2),24));
        sext_ln23_1_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(and_ln_fu_89_p7),15));

        sext_ln23_fu_86_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_1_reg_143),4));

    tmp_1_fu_62_p1 <= p;
    tmp_2_fu_72_p1 <= p;
    tmp_fu_54_p1 <= p;
    zext_ln23_fu_107_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln23_1_fu_103_p1),16));
end behav;
