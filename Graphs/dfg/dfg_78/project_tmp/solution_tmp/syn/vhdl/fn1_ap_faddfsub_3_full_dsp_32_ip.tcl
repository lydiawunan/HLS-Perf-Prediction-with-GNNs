...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name fn1_ap_faddfsub_3_full_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name fn1_ap_faddfsub_3_full_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips fn1_ap_faddfsub_3_full_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files fn1_ap_faddfsub_3_full_dsp_32.xci]
generate_target {synthesis simulation} [get_files fn1_ap_faddfsub_3_full_dsp_32.xci]
