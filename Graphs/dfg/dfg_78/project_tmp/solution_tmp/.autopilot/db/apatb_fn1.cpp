...
extern "C" short fn1_hw_stub_wrapper(int, long long, char);
...
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_7);
