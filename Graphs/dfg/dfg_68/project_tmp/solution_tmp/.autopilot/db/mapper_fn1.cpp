...
extern "C" char fn1(char, long long, long long*, short*, int);
extern "C" char apatb_fn1_hw(char __xlx_apatb_param_p, long long __xlx_apatb_param_p_5, volatile void * __xlx_apatb_param_p_9, volatile void * __xlx_apatb_param_p_11, int __xlx_apatb_param_p_13) {
  // Collect __xlx_p_9__tmp_vec
  vector<sc_bv<64> >__xlx_p_9__tmp_vec;
  for (int j = 0, e = 2; j != e; ++j) {
    __xlx_p_9__tmp_vec.push_back(((long long*)__xlx_apatb_param_p_9)[j]);
  }
  int __xlx_size_param_p_9 = 2;
  int __xlx_offset_param_p_9 = 0;
  int __xlx_offset_byte_param_p_9 = 0*8;
  long long* __xlx_p_9__input_buffer= new long long[__xlx_p_9__tmp_vec.size()];
  for (int i = 0; i < __xlx_p_9__tmp_vec.size(); ++i) {
    __xlx_p_9__input_buffer[i] = __xlx_p_9__tmp_vec[i].range(63, 0).to_uint64();
  }
  ...
  // DUT call
  char ap_return = fn1(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_p_9__input_buffer, __xlx_p_11__input_buffer, __xlx_apatb_param_p_13);
// print __xlx_apatb_param_p_9
  sc_bv<64>*__xlx_p_9_output_buffer = new sc_bv<64>[__xlx_size_param_p_9];
  for (int i = 0; i < __xlx_size_param_p_9; ++i) {
    __xlx_p_9_output_buffer[i] = __xlx_p_9__input_buffer[i+__xlx_offset_param_p_9];
  }
  for (int i = 0; i < __xlx_size_param_p_9; ++i) {
    ((long long*)__xlx_apatb_param_p_9)[i] = __xlx_p_9_output_buffer[i].to_uint64();
  }
