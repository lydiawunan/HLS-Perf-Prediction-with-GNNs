...
extern "C" char fn1_hw_stub_wrapper(char, long long, volatile void *, volatile void *, int);
...
// print p_9 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_9 = 0*8;
  if (__xlx_apatb_param_p_9) {
    for (int j = 0  - 0, e = 2 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_9)[j];
  ...
  tcl_file.set_num(2, &tcl_file.p_9_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_9, __xlx_sprintf_buffer.data());
}
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_p_11)[j];
  ...
  tcl_file.set_num(5, &tcl_file.p_11_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_11, __xlx_sprintf_buffer.data());
}
...
char ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
