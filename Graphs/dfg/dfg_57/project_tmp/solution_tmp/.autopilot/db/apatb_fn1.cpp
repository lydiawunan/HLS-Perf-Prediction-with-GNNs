...
extern "C" long long fn1_hw_stub_wrapper(char, long long, long long, volatile void *);
...
// print p_15 Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = *((long long*)&__xlx_apatb_param_p_15);
...
unsigned __xlx_offset_byte_param_p_17 = 0;
// print p_17 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_p_17, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_p_17 = 0*2;
  if (__xlx_apatb_param_p_17) {
    for (int j = 0  - 0, e = 6 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_p_17)[j];
  ...
  tcl_file.set_num(6, &tcl_file.p_17_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_17, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_13, __xlx_apatb_param_p_15, __xlx_apatb_param_p_17);
