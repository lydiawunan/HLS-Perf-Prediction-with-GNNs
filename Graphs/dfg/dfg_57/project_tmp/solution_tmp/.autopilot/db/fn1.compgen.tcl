...
set id 1
set name fn1_sdiv_64ns_32s_16_68_seq_1
...
set id 2
set name fn1_udiv_15s_10ns_6_19_seq_1
...
set id 3
set name fn1_urem_64s_10ns_8_68_seq_1
...
set id 4
set name fn1_mac_muladd_17s_17ns_9ns_32_4_1
...
set out_width 32
set exp i0*i1+i2
set arg_lists {i0 {17 1 +} i1 {17 0 +} m {32 1 +} i2 {9 0 +} p {32 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_17 \
    op interface \
    ports { p_17_address0 { O 3 vector } p_17_ce0 { O 1 bit } p_17_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'p_17'"
}
}
