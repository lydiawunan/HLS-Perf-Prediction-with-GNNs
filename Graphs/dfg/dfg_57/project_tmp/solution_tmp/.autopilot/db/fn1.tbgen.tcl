...
set C_modelArgList {
	...
	{ p_13 int 64 regular  }
	{ p_15 int 64 regular  }
	{ p_17 int 16 regular {array 6 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p","cData": "char","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "p_17", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p_17","cData": "short","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ p_13 sc_in sc_lv 64 signal 1 } 
	{ p_15 sc_in sc_lv 64 signal 2 } 
	{ p_17_address0 sc_out sc_lv 3 signal 3 } 
	{ p_17_ce0 sc_out sc_logic 1 signal 3 } 
	{ p_17_q0 sc_in sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_17_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "p_17", "role": "address0" }} , 
 	{ "name": "p_17_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_17", "role": "ce0" }} , 
 	{ "name": "p_17_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "p_17", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "p_17", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_64ns_32s_16_68_seq_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.udiv_15s_10ns_6_19_seq_1_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_64s_10ns_8_68_seq_1_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_17s_17ns_9ns_32_4_1_U4", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fn1 {
		p {Type I LastRead 54 FirstWrite -1}
		p_13 {Type I LastRead 4 FirstWrite -1}
		p_15 {Type I LastRead 4 FirstWrite -1}
		p_17 {Type I LastRead 72 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	p_17 { ap_memory {  { p_17_address0 mem_address 1 3 }  { p_17_ce0 mem_ce 1 1 }  { p_17_q0 mem_dout 0 16 } } }
}
