...
extern "C" double fn1_hw_stub_wrapper(long long, char, long long, int);
...
// print p_13 Transactions
{
  ...
  {
    sc_bv<64> __xlx_tmp_lv = *((long long*)&__xlx_apatb_param_p_13);
...
// print p_15 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_15);
...
double ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13, __xlx_apatb_param_p_15);
