...
extern "C" float fn1_hw_stub_wrapper(long long, long long, int, float);
...
// print p_7 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_7);
...
float ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_7, __xlx_apatb_param_p_11);
