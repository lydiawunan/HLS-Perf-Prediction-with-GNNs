...
extern "C" short fn1_hw_stub_wrapper(char, short);

extern "C" short apatb_fn1_hw(char __xlx_apatb_param_p, short __xlx_apatb_param_p_7) {
...
// print p_7 Transactions
{
  ...
  {
    sc_bv<16> __xlx_tmp_lv = *((short*)&__xlx_apatb_param_p_7);
...
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7);
