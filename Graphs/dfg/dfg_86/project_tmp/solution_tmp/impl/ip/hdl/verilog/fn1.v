...
(* CORE_GENERATION_INFO="fn1_fn1,hls_ip_2020_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.177687,HLS_SYN_LAT=230,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=4831,HLS_SYN_LUT=5378,HLS_VERSION=2020_2}" *)
...
reg   [7:0] srem_ln24_reg_485;
wire    ap_CS_fsm_state35;
wire    ap_CS_fsm_state36;
wire   [0:0] icmp_ln23_fu_148_p2;
reg   [0:0] icmp_ln23_reg_495;
wire    ap_CS_fsm_state103;
wire   [59:0] grp_fu_167_p2;
reg   [59:0] udiv_ln24_reg_510;
wire   [47:0] grp_fu_176_p2;
reg   [47:0] mul_ln23_reg_515;
wire    ap_CS_fsm_state104;
wire   [59:0] add_ln24_1_fu_185_p2;
reg   [59:0] add_ln24_1_reg_520;
wire    ap_CS_fsm_state105;
reg   [0:0] p_Result_s_reg_530;
wire    ap_CS_fsm_state138;
wire   [22:0] tmp_5_fu_234_p1;
reg   [22:0] tmp_5_reg_536;
wire   [0:0] isNeg_fu_248_p3;
reg   [0:0] isNeg_reg_541;
wire   [8:0] ush_fu_266_p3;
reg   [8:0] ush_reg_547;
wire   [15:0] val_fu_328_p3;
reg   [15:0] val_reg_552;
wire    ap_CS_fsm_state139;
wire   [63:0] val_1_fu_377_p3;
reg   [63:0] val_1_reg_558;
wire   [63:0] add_ln26_fu_395_p2;
reg   [63:0] add_ln26_reg_564;
wire    ap_CS_fsm_state140;
wire   [59:0] grp_fu_207_p2;
reg  signed [59:0] sdiv_ln23_reg_569;
wire    ap_CS_fsm_state157;
wire    ap_CS_fsm_state158;
wire   [63:0] grp_fu_409_p2;
reg   [63:0] mul_ln25_reg_579;
wire    ap_CS_fsm_state162;
wire   [16:0] grp_fu_401_p2;
reg   [16:0] sdiv_ln25_reg_584;
wire    ap_CS_fsm_state163;
wire   [17:0] grp_fu_432_p2;
reg   [17:0] srem_ln25_reg_594;
wire    ap_CS_fsm_state230;
wire  signed [31:0] trunc_ln21_fu_114_p0;
wire   [7:0] trunc_ln21_fu_114_p1;
wire   [7:0] v_17_fu_118_p2;
wire  signed [8:0] sext_ln24_fu_124_p1;
wire  signed [8:0] add_ln24_fu_128_p2;
wire   [31:0] v_9_fu_144_p1;
wire   [7:0] trunc_ln24_fu_154_p1;
wire   [7:0] sub_ln24_fu_157_p2;
wire   [7:0] grp_fu_167_p1;
wire  signed [15:0] grp_fu_176_p1;
wire   [59:0] trunc_ln24_1_fu_182_p1;
wire   [47:0] select_ln23_fu_191_p3;
wire   [47:0] and_ln23_fu_198_p2;
wire  signed [48:0] grp_fu_207_p0;
wire   [31:0] data_V_fu_212_p1;
wire   [7:0] tmp_4_fu_224_p4;
wire   [8:0] zext_ln341_fu_238_p1;
wire   [8:0] add_ln341_fu_242_p2;
wire   [7:0] sub_ln1311_fu_256_p2;
wire  signed [8:0] sext_ln1311_fu_262_p1;
wire   [24:0] mantissa_fu_274_p4;
wire  signed [31:0] sh_prom_i_i_i_i_i_cast_cast_cast_fu_287_p1;
wire   [62:0] zext_ln15_fu_283_p1;
wire   [62:0] sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_290_p1;
wire   [62:0] r_V_fu_294_p2;
wire   [0:0] tmp_fu_306_p3;
wire   [62:0] r_V_1_fu_300_p2;
wire   [15:0] zext_ln662_fu_314_p1;
wire   [15:0] tmp_1_fu_318_p4;
wire   [110:0] zext_ln15_1_fu_335_p1;
wire   [110:0] sh_prom_i_i_i_i_i21_cast_cast_cast_cast_fu_339_p1;
wire   [110:0] r_V_2_fu_343_p2;
wire   [0:0] tmp_2_fu_355_p3;
wire   [110:0] r_V_3_fu_349_p2;
wire   [63:0] zext_ln662_1_fu_363_p1;
wire   [63:0] tmp_3_fu_367_p4;
wire   [63:0] result_V_6_fu_384_p2;
wire   [63:0] result_V_7_fu_389_p3;
wire   [17:0] grp_fu_401_p0;
wire    ap_CS_fsm_state141;
wire   [32:0] grp_fu_409_p1;
wire   [16:0] trunc_ln26_fu_415_p1;
wire  signed [17:0] sext_ln26_fu_418_p1;
wire  signed [17:0] add_ln26_1_fu_422_p2;
wire    ap_CS_fsm_state231;
wire   [15:0] result_V_2_fu_437_p2;
wire   [17:0] trunc_ln25_fu_448_p1;
wire   [0:0] icmp_ln25_fu_451_p2;
wire   [15:0] result_V_fu_442_p3;
wire   [16:0] zext_ln25_fu_457_p1;
wire  signed [16:0] sext_ln25_1_fu_461_p1;
wire   [16:0] result_fu_465_p2;
reg    grp_fu_138_ap_start;
wire    grp_fu_138_ap_done;
...
fn1_srem_31ns_9s_8_35_seq_1 #(
    .ID( 1 ),
    .NUM_STAGE( 35 ),
    .din0_WIDTH( 31 ),
    .din1_WIDTH( 9 ),
    .dout_WIDTH( 8 ))
srem_31ns_9s_8_35_seq_1_U1(
    .clk(ap_clk),
    .reset(ap_rst),
    .start(grp_fu_138_ap_start),
    .done(grp_fu_138_ap_done),
    .din0(31'd976557278),
    .din1(add_ln24_fu_128_p2),
    .ce(1'b1),
    .dout(grp_fu_138_p2)
);
...
fn1_sdiv_49s_60ns_60_53_seq_1 #(
    ...
    .din1_WIDTH( 60 ),
    .dout_WIDTH( 60 ))
sdiv_49s_60ns_60_53_seq_1_U4(
    .clk(ap_clk),
    .reset(ap_rst),
    .start(grp_fu_207_ap_start),
    .done(grp_fu_207_ap_done),
    .din0(grp_fu_207_p0),
    .din1(add_ln24_1_reg_520),
    .ce(1'b1),
    .dout(grp_fu_207_p2)
);
...
fn1_sdiv_18ns_64ns_17_22_seq_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 17 ))
sdiv_18ns_64ns_17_22_seq_1_U5(
    .clk(ap_clk),
    .reset(ap_rst),
    .start(grp_fu_401_ap_start),
    .done(grp_fu_401_ap_done),
    .din0(grp_fu_401_p0),
    .din1(add_ln26_reg_564),
    .ce(1'b1),
    .dout(grp_fu_401_p2)
);
...
fn1_mul_60s_33ns_64_5_1 #(
    ...
    .din1_WIDTH( 33 ),
    .dout_WIDTH( 64 ))
mul_60s_33ns_64_5_1_U6(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(sdiv_ln23_reg_569),
    .din1(grp_fu_409_p1),
    .ce(1'b1),
    .dout(grp_fu_409_p2)
);
...
fn1_srem_64ns_18s_18_68_seq_1 #(
    ...
    .din1_WIDTH( 18 ),
    .dout_WIDTH( 18 ))
srem_64ns_18s_18_68_seq_1_U7(
    .clk(ap_clk),
    .reset(ap_rst),
    .start(grp_fu_432_ap_start),
    .done(grp_fu_432_ap_done),
    .din0(mul_ln25_reg_579),
    .din1(add_ln26_1_fu_422_p2),
    .ce(1'b1),
    .dout(grp_fu_432_p2)
);
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state104)) begin
        add_ln24_1_reg_520 <= add_ln24_1_fu_185_p2;
        mul_ln23_reg_515 <= grp_fu_176_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state140)) begin
        add_ln26_reg_564 <= add_ln26_fu_395_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state36)) begin
        icmp_ln23_reg_495 <= icmp_ln23_fu_148_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state138)) begin
        isNeg_reg_541 <= add_ln341_fu_242_p2[32'd8];
        p_Result_s_reg_530 <= data_V_fu_212_p1[32'd31];
        tmp_5_reg_536 <= tmp_5_fu_234_p1;
        ush_reg_547 <= ush_fu_266_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state162)) begin
        mul_ln25_reg_579 <= grp_fu_409_p2;
        sdiv_ln25_reg_584 <= grp_fu_401_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state157)) begin
        sdiv_ln23_reg_569 <= grp_fu_207_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state35)) begin
        srem_ln24_reg_485 <= grp_fu_138_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        srem_ln25_reg_594 <= grp_fu_432_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state103)) begin
        udiv_ln24_reg_510 <= grp_fu_167_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state139)) begin
        val_1_reg_558 <= val_1_fu_377_p3;
        val_reg_552 <= val_fu_328_p3;
    end
end
...
always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        grp_fu_138_ap_start = 1'b1;
    end else begin
        grp_fu_138_ap_start = 1'b0;
    end
end
...
assign add_ln24_1_fu_185_p2 = (trunc_ln24_1_fu_182_p1 + 60'd424);

assign add_ln24_fu_128_p2 = ($signed(sext_ln24_fu_124_p1) + $signed(9'd59));

assign add_ln26_1_fu_422_p2 = ($signed(sext_ln26_fu_418_p1) + $signed(18'd30));

assign add_ln26_fu_395_p2 = (result_V_7_fu_389_p3 + 64'd882);

assign add_ln341_fu_242_p2 = ($signed(zext_ln341_fu_238_p1) + $signed(9'd385));

assign and_ln23_fu_198_p2 = (select_ln23_fu_191_p3 & mul_ln23_reg_515);
...
assign ap_return = $signed(result_fu_465_p2);

assign data_V_fu_212_p1 = p;

assign grp_fu_167_p1 = grp_fu_167_p10;

assign grp_fu_167_p10 = sub_ln24_fu_157_p2;

assign grp_fu_176_p1 = 48'd281474976679612;

assign grp_fu_207_p0 = $signed(and_ln23_fu_198_p2);

assign grp_fu_401_p0 = 64'd45897;

assign grp_fu_409_p1 = 64'd4294938677;

assign icmp_ln23_fu_148_p2 = ((v_9_fu_144_p1 == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_451_p2 = ((trunc_ln25_fu_448_p1 == 18'd0) ? 1'b1 : 1'b0);

assign isNeg_fu_248_p3 = add_ln341_fu_242_p2[32'd8];

assign mantissa_fu_274_p4 = {{{{1'd1}, {tmp_5_reg_536}}}, {1'd0}};

assign r_V_1_fu_300_p2 = zext_ln15_fu_283_p1 << sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_290_p1;

assign r_V_2_fu_343_p2 = zext_ln15_1_fu_335_p1 >> sh_prom_i_i_i_i_i21_cast_cast_cast_cast_fu_339_p1;

assign r_V_3_fu_349_p2 = zext_ln15_1_fu_335_p1 << sh_prom_i_i_i_i_i21_cast_cast_cast_cast_fu_339_p1;

assign r_V_fu_294_p2 = zext_ln15_fu_283_p1 >> sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_290_p1;

assign result_V_2_fu_437_p2 = (16'd0 - val_reg_552);

assign result_V_6_fu_384_p2 = (64'd0 - val_1_reg_558);

assign result_V_7_fu_389_p3 = ((p_Result_s_reg_530[0:0] == 1'b1) ? result_V_6_fu_384_p2 : val_1_reg_558);

assign result_V_fu_442_p3 = ((p_Result_s_reg_530[0:0] == 1'b1) ? result_V_2_fu_437_p2 : val_reg_552);

assign result_fu_465_p2 = ($signed(zext_ln25_fu_457_p1) - $signed(sext_ln25_1_fu_461_p1));

assign select_ln23_fu_191_p3 = ((icmp_ln23_reg_495[0:0] == 1'b1) ? 48'd281474976664756 : 48'd0);

assign sext_ln1311_fu_262_p1 = $signed(sub_ln1311_fu_256_p2);

assign sext_ln24_fu_124_p1 = $signed(v_17_fu_118_p2);

assign sext_ln25_1_fu_461_p1 = $signed(result_V_fu_442_p3);

assign sext_ln26_fu_418_p1 = $signed(trunc_ln26_fu_415_p1);

assign sh_prom_i_i_i_i_i21_cast_cast_cast_cast_fu_339_p1 = $unsigned(sh_prom_i_i_i_i_i_cast_cast_cast_fu_287_p1);

assign sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_290_p1 = $unsigned(sh_prom_i_i_i_i_i_cast_cast_cast_fu_287_p1);

assign sh_prom_i_i_i_i_i_cast_cast_cast_fu_287_p1 = $signed(ush_reg_547);

assign sub_ln1311_fu_256_p2 = (8'd127 - tmp_4_fu_224_p4);

assign sub_ln24_fu_157_p2 = ($signed(8'd211) - $signed(trunc_ln24_fu_154_p1));

assign tmp_1_fu_318_p4 = {{r_V_1_fu_300_p2[39:24]}};

assign tmp_2_fu_355_p3 = r_V_2_fu_343_p2[32'd24];

assign tmp_3_fu_367_p4 = {{r_V_3_fu_349_p2[87:24]}};

assign tmp_4_fu_224_p4 = {{data_V_fu_212_p1[30:23]}};

assign tmp_5_fu_234_p1 = data_V_fu_212_p1[22:0];

assign tmp_fu_306_p3 = r_V_fu_294_p2[32'd24];

assign trunc_ln21_fu_114_p0 = p_11;

assign trunc_ln21_fu_114_p1 = trunc_ln21_fu_114_p0[7:0];

assign trunc_ln24_1_fu_182_p1 = udiv_ln24_reg_510[59:0];

assign trunc_ln24_fu_154_p1 = srem_ln24_reg_485[7:0];

assign trunc_ln25_fu_448_p1 = srem_ln25_reg_594[17:0];

assign trunc_ln26_fu_415_p1 = sdiv_ln25_reg_584[16:0];

assign ush_fu_266_p3 = ((isNeg_fu_248_p3[0:0] == 1'b1) ? sext_ln1311_fu_262_p1 : add_ln341_fu_242_p2);

assign v_17_fu_118_p2 = (trunc_ln21_fu_114_p1 ^ 8'd73);

assign v_9_fu_144_p1 = p_13[31:0];

assign val_1_fu_377_p3 = ((isNeg_reg_541[0:0] == 1'b1) ? zext_ln662_1_fu_363_p1 : tmp_3_fu_367_p4);

assign val_fu_328_p3 = ((isNeg_reg_541[0:0] == 1'b1) ? zext_ln662_fu_314_p1 : tmp_1_fu_318_p4);

assign zext_ln15_1_fu_335_p1 = mantissa_fu_274_p4;

assign zext_ln15_fu_283_p1 = mantissa_fu_274_p4;

assign zext_ln25_fu_457_p1 = icmp_ln25_fu_451_p2;

assign zext_ln341_fu_238_p1 = tmp_4_fu_224_p4;

assign zext_ln662_1_fu_363_p1 = tmp_2_fu_355_p3;

assign zext_ln662_fu_314_p1 = tmp_fu_306_p3;
