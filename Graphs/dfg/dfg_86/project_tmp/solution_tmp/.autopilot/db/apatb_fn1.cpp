...
extern "C" int fn1_hw_stub_wrapper(float, int, volatile void *);

extern "C" int apatb_fn1_hw(float __xlx_apatb_param_p, int __xlx_apatb_param_p_11, volatile void * __xlx_apatb_param_p_13) {
...
int ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_11, __xlx_apatb_param_p_13);
