...
proc create_root_design { parentCell } {
  ...
  set p_15_address0 [ create_bd_port -dir O -from 3 -to 0 -type data p_15_address0 ]
  set p_15_ce0 [ create_bd_port -dir O p_15_ce0 ]
  set p_15_q0 [ create_bd_port -dir I -from 15 -to 0 -type data p_15_q0 ]
  set p_4 [ create_bd_port -dir I -from 31 -to 0 -type data p_4 ]
  set p_9 [ create_bd_port -dir I -from 63 -to 0 -type data p_9 ]
  ...
  connect_bd_net -net hls_inst_p_15_address0 [get_bd_ports p_15_address0] [get_bd_pins hls_inst/p_15_address0]
  connect_bd_net -net hls_inst_p_15_ce0 [get_bd_ports p_15_ce0] [get_bd_pins hls_inst/p_15_ce0]
  connect_bd_net -net p_0_1 [get_bd_ports p] [get_bd_pins hls_inst/p]
  connect_bd_net -net p_15_q0_0_1 [get_bd_ports p_15_q0] [get_bd_pins hls_inst/p_15_q0]
