...
extern "C" long long fn1_hw_stub_wrapper(long long, int, long long, volatile void *);
...
unsigned __xlx_offset_byte_param_p_15 = 0;
// print p_15 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_p_15, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_p_15 = 0*2;
  if (__xlx_apatb_param_p_15) {
    for (int j = 0  - 0, e = 15 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_p_15)[j];
  ...
  tcl_file.set_num(15, &tcl_file.p_15_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_15, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_4, __xlx_apatb_param_p_9, __xlx_apatb_param_p_15);
