...
set id 2
set name fn1_mul_32ns_64s_64_5_1
...
set id 3
set name fn1_sdiv_9s_64ns_8_13_seq_1
...
set id 5
set name fn1_sdiv_64ns_33ns_64_68_seq_1
set corename simcore_sdiv_seq
set op sdiv
set stage_num 68
set max_latency -1
...
set id 6
set name fn1_ama_addmuladd_8ns_8ns_7ns_7ns_8_4_1
...
set out_width 8
set exp (i0+i1)*i2+i3
set arg_lists {i0 {8 0 +} i1 {8 0 +} s {8 1 +} i2 {7 0 +} m {8 1 +} i3 {7 0 +} p {8 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_15 \
    op interface \
    ports { p_15_address0 { O 4 vector } p_15_ce0 { O 1 bit } p_15_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'p_15'"
}
}
