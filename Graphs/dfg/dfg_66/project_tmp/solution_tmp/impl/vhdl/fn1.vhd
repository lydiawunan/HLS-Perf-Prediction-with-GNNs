...
architecture behav of fn1 is 
    ...
    "fn1_fn1,hls_ip_2020_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.972000,HLS_SYN_LAT=69,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1027,HLS_SYN_LUT=1594,HLS_VERSION=2020_2}";
    ...
    signal tmp_3_fu_98_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_3_reg_265 : STD_LOGIC_VECTOR (22 downto 0);
    signal isNeg_fu_112_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal isNeg_reg_270 : STD_LOGIC_VECTOR (0 downto 0);
    signal ush_fu_130_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal ush_reg_275 : STD_LOGIC_VECTOR (8 downto 0);
    signal val_fu_192_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal val_reg_280 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal result_V_2_fu_199_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal result_V_2_reg_285 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln24_fu_205_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal data_V_fu_76_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_fu_88_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln341_fu_102_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln341_fu_106_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal sub_ln1311_fu_120_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sext_ln1311_fu_126_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal mantissa_fu_138_p4 : STD_LOGIC_VECTOR (24 downto 0);
    signal sh_prom_i_i_i_i_i_cast_cast_cast_fu_151_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln15_fu_147_p1 : STD_LOGIC_VECTOR (78 downto 0);
    signal sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_154_p1 : STD_LOGIC_VECTOR (78 downto 0);
    signal r_V_fu_158_p2 : STD_LOGIC_VECTOR (78 downto 0);
    signal tmp_fu_170_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal r_V_1_fu_164_p2 : STD_LOGIC_VECTOR (78 downto 0);
    signal zext_ln662_fu_178_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_182_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln26_fu_211_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln26_fu_217_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln26_fu_221_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal result_V_fu_231_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal or_ln23_fu_236_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_246_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_246_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state70 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state70 : signal is "none";
    signal v_fu_251_p1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component fn1_udiv_64s_64ns_16_68_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    udiv_64s_64ns_16_68_seq_1_U1 : component fn1_udiv_64s_64ns_16_68_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 68,
        din0_WIDTH => 64,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                isNeg_reg_270 <= add_ln341_fu_106_p2(8 downto 8);
                p_Result_s_reg_260 <= data_V_fu_76_p1(31 downto 31);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((p_Result_s_reg_260 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    add_ln24_fu_205_p2 <= std_logic_vector(unsigned(p) + unsigned(ap_const_lv64_398));
    add_ln341_fu_106_p2 <= std_logic_vector(unsigned(zext_ln341_fu_102_p1) + unsigned(ap_const_lv9_181));
    ...
    ap_return <= (v_fu_251_p1 or sub_ln26_reg_295);
    data_V_fu_76_p1 <= p_13;

    grp_fu_246_ap_start_assign_proc : process(ap_CS_fsm_state3)
    begin
        ...
        grp_fu_246_p0 <= std_logic_vector(IEEE.numeric_std.resize(signed(or_ln23_fu_236_p2),64));

    icmp_ln26_fu_211_p2 <= "1" when (p = ap_const_lv64_0) else "0";
    isNeg_fu_112_p3 <= add_ln341_fu_106_p2(8 downto 8);
    mantissa_fu_138_p4 <= ((ap_const_lv1_1 & tmp_3_reg_265) & ap_const_lv1_0);
    or_ln23_fu_236_p2 <= (result_V_fu_231_p3 or ap_const_lv32_1);
    r_V_1_fu_164_p2 <= std_logic_vector(shift_left(unsigned(zext_ln15_fu_147_p1),to_integer(unsigned('0' & sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_154_p1(31-1 downto 0)))));
    r_V_fu_158_p2 <= std_logic_vector(shift_right(unsigned(zext_ln15_fu_147_p1),to_integer(unsigned('0' & sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_154_p1(31-1 downto 0)))));
    result_V_2_fu_199_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(val_fu_192_p3));
    result_V_fu_231_p3 <= 
        result_V_2_reg_285 when (p_Result_s_reg_260(0) = '1') else 
        val_reg_280;
        sext_ln1311_fu_126_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sub_ln1311_fu_120_p2),9));

    sh_prom_i_i_i_i_i_cast_cast_cast_cast_fu_154_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sh_prom_i_i_i_i_i_cast_cast_cast_fu_151_p1),79));
        sh_prom_i_i_i_i_i_cast_cast_cast_fu_151_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ush_reg_275),32));

    sub_ln1311_fu_120_p2 <= std_logic_vector(unsigned(ap_const_lv8_7F) - unsigned(tmp_2_fu_88_p4));
    sub_ln26_fu_225_p2 <= std_logic_vector(unsigned(trunc_ln26_fu_217_p1) - unsigned(zext_ln26_fu_221_p1));
    tmp_1_fu_182_p4 <= r_V_1_fu_164_p2(55 downto 24);
    tmp_2_fu_88_p4 <= data_V_fu_76_p1(30 downto 23);
    tmp_3_fu_98_p1 <= data_V_fu_76_p1(23 - 1 downto 0);
    tmp_fu_170_p3 <= r_V_fu_158_p2(24 downto 24);
    trunc_ln26_fu_217_p1 <= p(16 - 1 downto 0);
    ush_fu_130_p3 <= 
        sext_ln1311_fu_126_p1 when (isNeg_fu_112_p3(0) = '1') else 
        add_ln341_fu_106_p2;
    v_fu_251_p1 <= grp_fu_246_p2(16 - 1 downto 0);
    val_fu_192_p3 <= 
        zext_ln662_fu_178_p1 when (isNeg_reg_270(0) = '1') else 
        tmp_1_fu_182_p4;
    zext_ln15_fu_147_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(mantissa_fu_138_p4),79));
    zext_ln26_fu_221_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(icmp_ln26_fu_211_p2),16));
    zext_ln341_fu_102_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2_fu_88_p4),9));
    zext_ln662_fu_178_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_170_p3),32));
end behav;
