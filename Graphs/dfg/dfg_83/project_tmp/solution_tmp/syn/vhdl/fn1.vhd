...
architecture behav of fn1 is 
    ...
    "fn1_fn1,hls_ip_2020_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.842000,HLS_SYN_LAT=83,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1842,HLS_SYN_LUT=1567,HLS_VERSION=2020_2}";
    ...
    constant ap_const_lv64_3AB79310 : STD_LOGIC_VECTOR (63 downto 0) := "0000000000000000000000000000000000111010101101111001001100010000";
    ...
    signal v_5_fu_71_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_fu_84_p0 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln20_1_fu_89_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_100_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_CS_fsm_state17 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state17 : signal is "none";
    signal grp_fu_100_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state84 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state84 : signal is "none";
    signal grp_fu_84_ap_start : STD_LOGIC;
    signal grp_fu_84_ap_done : STD_LOGIC;
    signal grp_fu_100_ap_start : STD_LOGIC;
    signal grp_fu_100_ap_done : STD_LOGIC;
    signal ap_NS_fsm : STD_LOGIC_VECTOR (83 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component fn1_sdiv_9s_64ns_64_13_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component fn1_srem_64ns_31ns_8_68_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    sdiv_9s_64ns_64_13_seq_1_U1 : component fn1_sdiv_9s_64ns_64_13_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 13,
        din0_WIDTH => 9,
    ...
    srem_64ns_31ns_8_68_seq_1_U2 : component fn1_srem_64ns_31ns_8_68_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 68,
        din0_WIDTH => 64,
    ...
    add_ln20_1_fu_89_p2 <= std_logic_vector(unsigned(sdiv_ln20_reg_134) + unsigned(p));
    add_ln20_fu_75_p2 <= std_logic_vector(unsigned(p_7_q0) + unsigned(ap_const_lv64_1A5));
    ...
    ap_return <= grp_fu_100_p2(8 - 1 downto 0);

    grp_fu_100_ap_start_assign_proc : process(ap_CS_fsm_state17)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state17)) then 
            grp_fu_100_ap_start <= ap_const_logic_1;
        else 
            grp_fu_100_ap_start <= ap_const_logic_0;
        end if; 
    end process;

    grp_fu_100_p1 <= ap_const_lv64_3AB79310(31 - 1 downto 0);

    grp_fu_84_ap_start_assign_proc : process(ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            grp_fu_84_ap_start <= ap_const_logic_1;
        else 
            grp_fu_84_ap_start <= ap_const_logic_0;
        end if; 
    end process;

        grp_fu_84_p0 <= std_logic_vector(IEEE.numeric_std.resize(signed(v_5_reg_119),9));

    p_7_address0 <= ap_const_lv64_0(3 - 1 downto 0);
    p_7_address1 <= ap_const_lv64_1(3 - 1 downto 0);

    p_7_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    p_7_ce1_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            p_7_ce1 <= ap_const_logic_1;
        else 
            p_7_ce1 <= ap_const_logic_0;
        end if; 
    end process;

    sub_ln19_fu_94_p2 <= std_logic_vector(unsigned(ap_const_lv64_0) - unsigned(add_ln20_1_fu_89_p2));
    v_5_fu_71_p1 <= p_7_q1(8 - 1 downto 0);
end behav;
