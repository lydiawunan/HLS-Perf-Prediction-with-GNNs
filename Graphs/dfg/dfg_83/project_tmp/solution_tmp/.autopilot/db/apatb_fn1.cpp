...
extern "C" char fn1_hw_stub_wrapper(long long, volatile void *, char, short);

extern "C" char apatb_fn1_hw(long long __xlx_apatb_param_p, volatile void * __xlx_apatb_param_p_7, char __xlx_apatb_param_p_13, short __xlx_apatb_param_p_15) {
...
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_7)[j];
  ...
  tcl_file.set_num(5, &tcl_file.p_7_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_7, __xlx_sprintf_buffer.data());
}
// print p_13 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_13);
...
char ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_13, __xlx_apatb_param_p_15);
