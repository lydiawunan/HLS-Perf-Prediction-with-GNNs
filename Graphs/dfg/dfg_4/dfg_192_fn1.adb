  ...
  <syndb class_id="0" tracking_level="0" version="0">
        ...
        <item class_id_reference="9" object_id="_4">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>sext_ln12_fu_38_p1</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_9">
          <Value>
            <Obj>
              ...
              <originalName/>
              <rtlName>icmp_ln16_fu_63_p2</rtlName>
              <control/>
              <opType>icmp</opType>
              <implIndex/>
              <coreName/>
        ...
        <item class_id_reference="9" object_id="_10">
          <Value>
            <Obj>
              ...
              <rtlName>result_1_fu_68_p3</rtlName>
              <control/>
              <opType/>
              <implIndex/>
              <coreName/>
    ...
    <res class_id="34" tracking_level="1" version="0" object_id="_117">
      ...
      <dp_expression_resource>
        ...
        <item>
          <first>icmp_ln16_fu_63_p2 ( icmp ) </first>
          <second>
            <count>4</count>
            <item_version>0</item_version>
            <item>
