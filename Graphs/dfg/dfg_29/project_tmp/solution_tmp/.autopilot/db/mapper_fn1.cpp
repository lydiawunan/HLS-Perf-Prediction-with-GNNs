...
extern "C" int fn1(char*, long long);
extern "C" int apatb_fn1_hw(volatile void * __xlx_apatb_param_p, long long __xlx_apatb_param_p_9) {
  ...
  // DUT call
  int ap_return = fn1(__xlx_p__input_buffer, __xlx_apatb_param_p_9);
