...
extern "C" char fn1_hw_stub_wrapper(volatile void *, float, long long, short);

extern "C" char apatb_fn1_hw(volatile void * __xlx_apatb_param_p, float __xlx_apatb_param_p_9, long long __xlx_apatb_param_p_11, short __xlx_apatb_param_p_19) {
...
// print p Transactions
{
  ...
  {  __xlx_offset_byte_param_p = 0*8;
  if (__xlx_apatb_param_p) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p)[j];
...
// print p_19 Transactions
{
  ...
  {
    sc_bv<16> __xlx_tmp_lv = *((short*)&__xlx_apatb_param_p_19);
...
char ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_19);
