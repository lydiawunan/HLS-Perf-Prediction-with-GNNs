...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("p_address0", 4, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("p_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("p_q0", 8, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("p_address1", 4, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("p_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("p_q1", 8, hls_in, 0, "ap_memory", "MemPortDOUT2", 1),
