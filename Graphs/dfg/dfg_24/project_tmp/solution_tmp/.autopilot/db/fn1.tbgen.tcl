...
set C_modelArgList {
	{ p int 8 regular {array 9 { 1 1 } 1 1 }  }
	{ p_4 uint 16 regular  }
}
...
set portList { 
	...
	{ p_address1 sc_out sc_lv 4 signal 0 } 
	{ p_ce1 sc_out sc_logic 1 signal 0 } 
	{ p_q1 sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "p", "role": "address1" }} , 
 	{ "name": "p_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p", "role": "ce1" }} , 
 	{ "name": "p_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_32s_64_6_no_dsp_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_16ns_15ns_14_20_seq_1_U2", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fn1 {
		p {Type I LastRead 19 FirstWrite -1}
...
set Spec2ImplPortList { 
	p { ap_memory {  { p_address0 mem_address 1 4 }  { p_ce0 mem_ce 1 1 }  { p_q0 mem_dout 0 8 }  { p_address1 MemPortADDR2 1 4 }  { p_ce1 MemPortCE2 1 1 }  { p_q1 MemPortDOUT2 0 8 } } }
