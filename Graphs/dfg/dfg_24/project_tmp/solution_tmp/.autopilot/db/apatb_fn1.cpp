...
extern "C" double fn1_hw_stub_wrapper(volatile void *, short);

extern "C" double apatb_fn1_hw(volatile void * __xlx_apatb_param_p, short __xlx_apatb_param_p_4) {
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p)[j];
  ...
  tcl_file.set_num(9, &tcl_file.p_depth);
...
// print p_4 Transactions
{
  ...
  {
    sc_bv<16> __xlx_tmp_lv = *((short*)&__xlx_apatb_param_p_4);
...
double ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_4);
