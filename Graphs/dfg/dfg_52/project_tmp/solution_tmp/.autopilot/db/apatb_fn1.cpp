...
extern "C" float fn1_hw_stub_wrapper(long long, char, char, volatile void *);
...
// print p_5 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_5);
...
// print p_9 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_9);
...
// print p_11 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_11 = 0*1;
  if (__xlx_apatb_param_p_11) {
    for (int j = 0  - 0, e = 15 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p_11)[j];
  ...
  tcl_file.set_num(15, &tcl_file.p_11_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_11, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
float ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_5, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11);
