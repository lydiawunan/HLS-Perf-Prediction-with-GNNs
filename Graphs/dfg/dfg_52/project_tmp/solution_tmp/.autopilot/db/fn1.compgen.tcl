...
set id 6
set name fn1_urem_8ns_10ns_8_12_seq_1
...
set id 7
set name fn1_ama_submuladd_6s_8ns_8ns_8ns_8_4_1
...
set out_width 8
set exp (i0+i1)*i2+i3
set arg_lists {i0 {6 1 +} i1 {8 0 -} s {8 1 +} i2 {8 0 +} m {8 1 +} i3 {8 0 +} p {8 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_11 \
    op interface \
    ports { p_11_address0 { O 4 vector } p_11_ce0 { O 1 bit } p_11_q0 { I 8 vector } } \
} "
} else {
