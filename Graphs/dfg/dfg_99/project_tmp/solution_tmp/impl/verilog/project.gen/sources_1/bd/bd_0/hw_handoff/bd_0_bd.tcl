...
proc create_root_design { parentCell } {
  ...
  set p_7 [ create_bd_port -dir I -from 7 -to 0 -type data p_7 ]
  set p_11 [ create_bd_port -dir I -from 31 -to 0 -type data p_11 ]
  set p_9_address0 [ create_bd_port -dir O -from 3 -to 0 -type data p_9_address0 ]
  ...
  connect_bd_net -net p_11_0_1 [get_bd_ports p_11] [get_bd_pins hls_inst/p_11]
