...
extern "C" double fn1_hw_stub_wrapper(int, char, volatile void *, int);
...
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_9)[j];
  ...
  tcl_file.set_num(15, &tcl_file.p_9_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_9, __xlx_sprintf_buffer.data());
}
...
double ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11);
