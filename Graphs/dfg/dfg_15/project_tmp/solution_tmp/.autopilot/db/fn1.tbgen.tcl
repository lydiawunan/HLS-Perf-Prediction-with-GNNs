...
set C_modelArgList {
	{ p int 64 regular {array 15 { 1 3 } 1 1 }  }
	{ p_9 int 8 regular {array 4 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ p_9_address0 sc_out sc_lv 2 signal 1 } 
	{ p_9_ce0 sc_out sc_logic 1 signal 1 } 
	{ p_9_q0 sc_in sc_lv 8 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.uitofp_64s_32_6_no_dsp_1_U1", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	fn1 {
		p {Type I LastRead 84 FirstWrite -1}
...
set Spec2ImplPortList { 
	p { ap_memory {  { p_address0 mem_address 1 4 }  { p_ce0 mem_ce 1 1 }  { p_q0 mem_dout 0 64 } } }
	p_9 { ap_memory {  { p_9_address0 mem_address 1 2 }  { p_9_ce0 mem_ce 1 1 }  { p_9_q0 mem_dout 0 8 } } }
}
