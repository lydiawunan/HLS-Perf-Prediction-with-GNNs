...
extern "C" float fn1(long long*, char*);
extern "C" float apatb_fn1_hw(volatile void * __xlx_apatb_param_p, volatile void * __xlx_apatb_param_p_9) {
  ...
  // DUT call
  float ap_return = fn1(__xlx_p__input_buffer, __xlx_p_9__input_buffer);
