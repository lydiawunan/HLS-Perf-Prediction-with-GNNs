...
set C_modelArgList {
	{ p int 64 regular  }
	{ p_9 uint 16 regular  }
	{ p_11 int 64 regular {array 8 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "p_11", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "p_11","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ p_9 sc_in sc_lv 16 signal 1 } 
	{ p_11_address0 sc_out sc_lv 3 signal 2 } 
	{ p_11_ce0 sc_out sc_logic 1 signal 2 } 
	{ p_11_q0 sc_in sc_lv 64 signal 2 } 
	{ p_13 sc_in sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_11_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "p_11", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.uitodp_32ns_64_6_no_dsp_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_64ns_64ns_8_68_seq_1_U2", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	fn1 {
		p {Type I LastRead 2 FirstWrite -1}
		p_9 {Type I LastRead 3 FirstWrite -1}
		p_11 {Type I LastRead 2 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	p_11 { ap_memory {  { p_11_address0 mem_address 1 3 }  { p_11_ce0 mem_ce 1 1 }  { p_11_q0 mem_dout 0 64 } } }
