...
extern "C" long long fn1_hw_stub_wrapper(volatile void *, int, char);
...
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p)[j];
  ...
  tcl_file.set_num(24, &tcl_file.p_depth);
...
// print p_17 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_17);
...
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_15, __xlx_apatb_param_p_17);
