...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.P_17 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.P_17, LAYERED_METADATA undef" *) input [7:0]p_17;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.P_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.P_ADDRESS0, LAYERED_METADATA undef" *) output [4:0]p_address0;
  output p_ce0;
  ...
  assign p_17_0_1 = p_17[7:0];
  assign p_address0[4:0] = hls_inst_p_address0;
