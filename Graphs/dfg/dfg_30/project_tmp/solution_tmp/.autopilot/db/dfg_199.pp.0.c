...
__attribute__((sdx_kernel("fn1", 0))) unsigned short fn1(unsigned char p, char p_7, unsigned int p_9[5],
                   short p_15, long p_19[1])
{_ssdm_SpecArrayDimSize(p_9, 5);_ssdm_SpecArrayDimSize(p_19, 1);
