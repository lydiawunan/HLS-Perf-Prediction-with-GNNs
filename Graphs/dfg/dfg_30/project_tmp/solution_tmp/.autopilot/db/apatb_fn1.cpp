...
extern "C" short fn1_hw_stub_wrapper(char, char, volatile void *, short, volatile void *);
...
// print p_7 Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_7);
...
// print p_9 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_9 = 0*4;
  if (__xlx_apatb_param_p_9) {
    for (int j = 0  - 0, e = 5 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_p_9)[j];
  ...
  tcl_file.set_num(5, &tcl_file.p_9_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_9, __xlx_sprintf_buffer.data());
}
...
short ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_15, __xlx_apatb_param_p_19);
