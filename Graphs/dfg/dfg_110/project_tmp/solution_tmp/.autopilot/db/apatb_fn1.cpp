...
// wrapc file define:
#define AUTOTB_TVIN_p_21 "../tv/cdatafile/c.fn1.autotvin_p_21.dat"
#define AUTOTB_TVOUT_p_21 "../tv/cdatafile/c.fn1.autotvout_p_21.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_p_21 "../tv/rtldatafile/rtl.fn1.autotvout_p_21.dat"
...
extern "C" long long fn1_hw_stub_wrapper(int, short, long long, int, char);

extern "C" long long apatb_fn1_hw(int __xlx_apatb_param_p, short __xlx_apatb_param_p_11, long long __xlx_apatb_param_p_17, int __xlx_apatb_param_p_19, char __xlx_apatb_param_p_21) {
...
//p_21
aesl_fh.touch(AUTOTB_TVIN_p_21);
aesl_fh.touch(AUTOTB_TVOUT_p_21);
...
// print p_19 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_19);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_p_19, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.p_19_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_19, __xlx_sprintf_buffer.data());
}
// print p_21 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_p_21, __xlx_sprintf_buffer.data());
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_p_21);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_p_21, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.p_21_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_21, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_11, __xlx_apatb_param_p_17, __xlx_apatb_param_p_19, __xlx_apatb_param_p_21);
