...
extern "C" long long fn1_hw_stub_wrapper(short, double, volatile void *, char, volatile void *);
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_p_9)[j];
  ...
  tcl_file.set_num(6, &tcl_file.p_9_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_9, __xlx_sprintf_buffer.data());
}
...
// print p_15 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_15 = 0*8;
  if (__xlx_apatb_param_p_15) {
    for (int j = 0  - 0, e = 12 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_p_15)[j];
  ...
  tcl_file.set_num(12, &tcl_file.p_15_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_15, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_7, __xlx_apatb_param_p_9, __xlx_apatb_param_p_11, __xlx_apatb_param_p_15);
