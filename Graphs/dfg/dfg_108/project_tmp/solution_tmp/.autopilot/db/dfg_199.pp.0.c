...
__attribute__((sdx_kernel("fn1", 0))) unsigned long fn1(unsigned short p, double p_7, signed char p_9[3][2],
                  unsigned char p_11, long long p_15[3][4])
{_ssdm_SpecArrayDimSize(p_9, 3);_ssdm_SpecArrayDimSize(p_15, 3);
