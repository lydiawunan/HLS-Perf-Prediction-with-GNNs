...
// wrapc file define:
#define AUTOTB_TVIN_p_4 "../tv/cdatafile/c.fn1.autotvin_p_4.dat"
#define AUTOTB_TVOUT_p_4 "../tv/cdatafile/c.fn1.autotvout_p_4.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_p_4 "../tv/rtldatafile/rtl.fn1.autotvout_p_4.dat"
// tvout file define:
...
extern "C" long long fn1_hw_stub_wrapper(long long, int, volatile void *);

extern "C" long long apatb_fn1_hw(long long __xlx_apatb_param_p, int __xlx_apatb_param_p_4, volatile void * __xlx_apatb_param_p_11) {
...
//p_4
aesl_fh.touch(AUTOTB_TVIN_p_4);
aesl_fh.touch(AUTOTB_TVOUT_p_4);
//p_11
...
// print p_4 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_p_4, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_p_4);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_p_4, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.p_4_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_4, __xlx_sprintf_buffer.data());
}
...
// print p_11 Transactions
{
  ...
  {  __xlx_offset_byte_param_p_11 = 0*2;
  if (__xlx_apatb_param_p_11) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_p_11)[j];
  ...
  tcl_file.set_num(4, &tcl_file.p_11_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_p_11, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
long long ap_return = fn1_hw_stub_wrapper(__xlx_apatb_param_p, __xlx_apatb_param_p_4, __xlx_apatb_param_p_11);
