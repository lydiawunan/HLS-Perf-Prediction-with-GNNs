...
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.top_cdfg.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.top_cdfg.autotvout_a.dat"
// wrapc file define:
#define AUTOTB_TVIN_b "../tv/cdatafile/c.top_cdfg.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.top_cdfg.autotvout_b.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.top_cdfg.autotvout_a.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.top_cdfg.autotvout_b.dat"
...
extern "C" void top_cdfg_hw_stub_wrapper(volatile void *, volatile void *);
...
extern "C" void apatb_top_cdfg_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b) {
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > b_pc_buffer(1);
          int i = 0;
          ...
          if (i > 0) {
            ((int*)__xlx_apatb_param_b)[0] = b_pc_buffer[0].to_int64();
          }
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
top_cdfg_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b);
